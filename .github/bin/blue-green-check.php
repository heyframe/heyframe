...
$application->setName('HeyFrame');
$application->setVersion($kernel->getContainer()->getParameter('kernel.heyframe_version'));
...
$errorsPerClass = array_filter($errorsPerClass, static function (array $errors): bool {
    $classErrors = array_filter($errors, static function (string $error): bool {
