...
use HeyFrame\Core\Maintenance\User\Command\UserCreateCommand;
...
class UserCreateCommandTest extends TestCase
{
    ...
    public function testEmptyPasswordOption(): void
    {
        ...
        static::assertStringContainsString('[OK] User "heyframe" successfully created. The newly generated password is:', $output);
    }
