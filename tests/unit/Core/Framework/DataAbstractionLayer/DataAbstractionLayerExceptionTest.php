...
namespace HeyFrame\Tests\Unit\Core\Framework\DataAbstractionLayer;
...
use HeyFrame\Core\Framework\DataAbstractionLayer\Exception\InvalidSortQueryException;
...
class DataAbstractionLayerExceptionTest extends TestCase
{
    ...
    public function testFkFieldByStorageNameNotFound(): void
    {
        ...
        static::assertSame(
            'Can not detect FK field with storage name taxId in definition HeyFrame\Core\Content\Product\ProductDefinition',
            $e->getMessage()
        );
    ...
    public function testLanguageFieldByStorageNameNotFound(): void
    {
        ...
        static::assertSame(
            'Can not detect language field with storage name taxId in definition HeyFrame\Core\Content\Product\ProductDefinition',
            $e->getMessage()
        );
        static::assertSame(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertSame(DataAbstractionLayerException::REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND, $e->getErrorCode());
    ...
    public function testDefinitionFieldDoesNotExist(): void
    {
        ...
        static::assertSame(
            'Can not detect reference field with storage name taxId in definition HeyFrame\Core\Content\Product\ProductDefinition',
            $e->getMessage()
        );
        static::assertSame(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertSame(DataAbstractionLayerException::REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND, $e->getErrorCode());
