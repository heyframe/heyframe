...
class UrlEncoderTest extends TestCase
{
    ...
    {
        $url = 'https://heyframe.com:80/some/thing';
    ...
    {
        $url = 'https://heyframe.com/some/thing';
        static::assertSame($url, UrlEncoder::encodeUrl($url));
    }

    public function testRespectsQueryParameter(): void
    {
        $url = 'https://heyframe.com/some/thing?a=3&b=25';
        static::assertSame($url, UrlEncoder::encodeUrl($url));
    }
    ...
    {
        static::assertSame(
            'heyframe.com/some/thing',
            UrlEncoder::encodeUrl('heyframe.com/some/thing')
        );
    }
    ...
    {
        static::assertSame(
            'https://heyframe.com:80/so%20me/thing%20new.jpg',
            UrlEncoder::encodeUrl('https://heyframe.com:80/so me/thing new.jpg')
        );
    }
    ...
    {
        static::assertSame(
            'https://heyframe.com/path/%C3%A4%C3%B6%C3%BC%20test.jpg',
            UrlEncoder::encodeUrl('https://heyframe.com/path/äöü test.jpg')
        );
    }
    ...
    {
        static::assertSame(
            'https://heyframe.com/path/file%20name.jpg',
            UrlEncoder::encodeUrl('https://heyframe.com/path/file name.jpg#section')
        );
    }
