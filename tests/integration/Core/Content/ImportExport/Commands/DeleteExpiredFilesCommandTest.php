...
namespace HeyFrame\Tests\Integration\Core\Content\ImportExport\Commands;

use HeyFrame\Core\Content\ImportExport\Aggregate\ImportExportFile\ImportExportFileEntity;
use HeyFrame\Core\Content\ImportExport\Command\DeleteExpiredFilesCommand;
...
class DeleteExpiredFilesCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->filesystem = $this->getFilesystem('heyframe.filesystem.private');
    }
    ...
    public function testExecuteWithSomeFilesExpired(): void
    {
        ...
        static::assertCount($num - $numExpired, $results);
