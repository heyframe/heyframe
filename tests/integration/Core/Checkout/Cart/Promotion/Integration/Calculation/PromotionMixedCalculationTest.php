...
class PromotionMixedCalculationTest extends TestCase
{
    ...
    public function testRemoveDiscountByCode(): void
    {
        ...
        // add a new sample product
        $this->createTestFixtureProduct($productId, 119, static::getContainer(), $context);
    ...
    public function testSetGroupDiscountOnlyOnCompleteSets(): void
    {
        ...
        // add 4 test products
        $this->createTestFixtureProduct($set1ProductId1, 10, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($set1ProductId2, 20, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($set2ProductId1, 30, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($set2ProductId2, 40, static::getContainer(), $this->context);
    ...
    public function testSetGroupPackageAndPickerCombinations(
        ...
        // add 3 test products
        $this->createTestFixtureProduct($setProductId1, 10, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($setProductId2, 20, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($fooProductId, 50, static::getContainer(), $this->context);
    ...
    public function testBuy3TshirtsGetFirstOneFree(float $expectedDiscount, string $pickingType): void
    {
        ...
        // add 4 test products
        $this->createTestFixtureProduct($tshirt1, 5, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt2, 10, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt3, 15, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt4, 20, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt5, 25, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt6, 30, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt7, 35, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt8, 40, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($tshirt9, 45, static::getContainer(), $this->context);
