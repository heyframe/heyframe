...
class PromotionDiscountCompositionTest extends TestCase
{
    ...
    public function testCompositionInAbsoluteDiscount(): void
    {
        ...
        $this->createTestFixtureProduct($productId1, 50, static::getContainer(), $this->context);
        $this->createTestFixtureProduct($productId2, 100, static::getContainer(), $this->context);
    ...
    public function testPromotionRedemption(): void
    {
        ...
        // add a new sample product
        $this->createTestFixtureProduct($productId1, 50, static::getContainer(), $context);
        $this->createTestFixtureProduct($productId2, 100, static::getContainer(), $context);
     ...
     */
    private function orderWithPromotion(string $code, array $productIds, ChannelContext $context): string
    {
