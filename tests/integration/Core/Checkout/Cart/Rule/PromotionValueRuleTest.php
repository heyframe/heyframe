...
use HeyFrame\Core\Checkout\Promotion\Rule\PromotionCodeOfTypeRule;
use HeyFrame\Core\Checkout\Promotion\Rule\PromotionValueRule;
...
class PromotionValueRuleTest extends TestCase
{
    ...
    private function assertRuleMatches(Cart $cart): void
    {
        ...
        $mock = $this->createMock(ChannelContext::class);
