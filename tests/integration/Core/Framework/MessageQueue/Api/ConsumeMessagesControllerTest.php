...
use HeyFrame\Core\Content\Product\DataAbstractionLayer\ProductIndexingMessage;
...
use HeyFrame\Tests\Integration\Core\Framework\MessageQueue\fixtures\TestTask;
...
class ConsumeMessagesControllerTest extends TestCase
{
    ...
    {
        $this->incrementer = static::getContainer()->get('heyframe.increment.gateway.registry')->get(IncrementGatewayRegistry::MESSAGE_QUEUE_POOL);
    }
    ...
    public function testMessageStatsDecrement(): void
    {
        ...
        $gateway = static::getContainer()->get('heyframe.increment.gateway.registry');
