...
namespace HeyFrame\Tests\Integration\Core\Framework\Routing;
...
use HeyFrame\Core\Framework\Routing\ApiRequestContextResolver;
use HeyFrame\Core\Framework\Routing\ApiRouteScope;
use HeyFrame\Core\Framework\Routing\RequestContextResolverInterface;
...
class ApiRequestContextResolverTest extends TestCase
{
    ...
    public function testAdminIntegrationIdHeaderUserNeedsToBePrivileged(): void
    {
        ...
        static::assertSame(['currency:read'], $detail['missingPrivileges']);
    }
