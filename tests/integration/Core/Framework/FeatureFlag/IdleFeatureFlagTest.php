...
namespace HeyFrame\Tests\Integration\Core\Framework\FeatureFlag;
...
class IdleFeatureFlagTest extends TestCase
{
    ...
    final public const EXCLUDED_DIRS = [
        ...
        'Frontend/Resources/app/frontend/node_modules',
        'Frontend/Resources/app/frontend/test/e2e/node_modules',
    ];
    ...
    final public const EXCLUDE_BY_FLAG = [
        ...
        'FEATURE_NEXT_1234',
        'FEATURE_NEXT_1235',
        'FEATURE_NEXT_0000', /** @see \HeyFrame\Tests\Unit\Core\Framework\FeatureTest */
    ];
    ...
    protected function setUp(): void
    {
        ...
        Feature::registerFeatures(self::getContainer()->getParameter('heyframe.feature.flags'));
    }
