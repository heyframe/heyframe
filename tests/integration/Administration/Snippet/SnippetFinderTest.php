...
use HeyFrame\Tests\Unit\Core\System\Snippet\Service\TestableTranslationConfigLoader;
...
class SnippetFinderTest extends TestCase
{
    ...
    {
        $actual = $this->getResultSnippetsByCase('caseSameLanguage', 'zh');
    ...
    {
        $actual = $this->getResultSnippetsByCase('caseDifferentLanguages', 'zh');
    ...
    {
        $actualDe = $this->getResultSnippetsByCase('caseMultipleSameAndDifferentLanguages', 'zh');
