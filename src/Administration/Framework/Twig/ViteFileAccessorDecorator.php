...
class ViteFileAccessorDecorator extends FileAccessor
{
     ...
     * @return array<string, mixed>
     */
    public function getBundleData(HeyFrameBundle $bundle): array
    {
    ...
    private function getTechnicalBundleName(HeyFrameBundle $bundle): string
    {
     ...
     * @return array<string, mixed>
     */
    private function getContent(string $fileType, HeyFrameBundle $bundle): array
    {
        ...
        if (!isset($this->content[$bundle->getName()][$fileType])) {
            ...
            foreach ($content['entryPoints'][$technicalBundleName] ?? [] as $key => $entrypoint) {
                ...
                foreach ($entrypoint as $index => $entry) {
                    ...
                    // @see \HeyFrame\Core\Framework\Plugin\Util\AssetService::getTargetDirectory
