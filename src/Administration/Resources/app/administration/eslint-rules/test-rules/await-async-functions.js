...
const getAsyncExpressionName = (node) => {
    // HeyFrame.Component.build
    if (node.callee?.object?.object?.name === 'HeyFrame' && node.callee?.object?.property?.name === 'Component' && node.callee?.property?.name === 'build') {
        return 'HeyFrame.Component.build';
    }
