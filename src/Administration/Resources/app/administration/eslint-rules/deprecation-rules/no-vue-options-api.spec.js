...
export default {
    ...
    compatConfig: HeyFrame.compatConfig,
...
export default {
    ...
    computed: {
        ...
        isHeyFrameDefaultTax() {
            return this.$te(\`global.tax-rates.\${this.tax.name}\`, 'en-GB');
        },

        label() {
            return this.isHeyFrameDefaultTax ? this.$tc(\`global.tax-rates.\${this.tax.name}\`) : this.tax.name;
        },
    ...
    methods: {
        ...
        onChangeLanguage(languageId) {
            HeyFrame.State.commit('context/setApiLanguageId', languageId);
            this.createdComponent();
        },
...
'            };\n' +
'        });\n' +
'          const isHeyFrameDefaultTax = computed(() => {\n' +
"            return this.$te(`global.tax-rates.${tax.name}`, 'en-GB');\n" +
'        });\n' +
'          const label = computed(() => {\n' +
'            return isHeyFrameDefaultTax.value ? this.$tc(`global.tax-rates.${tax.name}`) : tax.name;\n' +
'        });\n' +
...
const { Mixin, Data: { Criteria } } = HeyFrame;
