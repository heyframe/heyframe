...
yetAnotherThing();
      ...
      `,
        ...
        const obj = {
          sliderLength() {
              const children = HeyFrame.Utils.VueHelper.getCompatChildren();
...
return true;
      ...
      `,
        ...
        const children = this.isCompatEnabled('INSTANCE_CHILDREN')
                ? this.$children
                : HeyFrame.Utils.VueHelper.getCompatChildren();
      `,
            output: `
        const children = HeyFrame.Utils.VueHelper.getCompatChildren();
      `,
        ...
        },
        {
            ...
            code: `const children = this.isCompatEnabled('INSTANCE_CHILDREN') ? this.$children : HeyFrame.Utils.VueHelper.getCompatChildren();`,
            output: `const children = HeyFrame.Utils.VueHelper.getCompatChildren();`,
            errors: [{ message: 'Feature flag condition should be removed' }],
        },
        {
