 ...
 * @private - Only to be used by heyframe directly
 *
...
export default function viteOverridePlugin(options: Options): Plugin {
    ...
    return {
        name: 'heyframe-vite-plugin-override-component',
        ...
        transform(code, id) {
            ...
            const registers = componentNames
                .map((name) => {
                    return `HeyFrame.Component.registerOverrideComponent(${name});`;
                })
                .join('\n');
            ...
            return {
                code: `
                /* Start: auto generated by HeyFrame */\n
                ${imports}\n${registers}\n
                /* End: auto generated by HeyFrame */\n\n
                ${code}`,
                map: null,
            };
        },
