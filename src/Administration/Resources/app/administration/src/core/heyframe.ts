...
class HeyFrameClass implements CustomHeyFrameProperties {
    /**
     * @private
     */
    ...
    public Component = {
        ...
        registerOverrideComponent: (component: DefineComponent<unknown, unknown, unknown>) => {
            HeyFrameClass.#overrideComponents.value.push(component);
        },
        /**
         * @experimental stableVersion:v6.8.0 feature:ADMIN_COMPOSITION_API_EXTENSION_SYSTEM
         */
        getOverrideComponents: () => {
            return HeyFrameClass.#overrideComponents.value;
        },
    };
    ...
    public Defaults = {
        ...
        frontendChannelTypeId: '8a243080f92e4c719546314b577cf82b',
    ...
    public get Snippet() {
        return {
            ...
            ...HeyFrame.Application.view.i18n.global,
            // @ts-expect-error - type is currently not available
            tc: HeyFrame.Application.view.i18n.global.t,
        };
    }
    ...
    public Constants: CustomHeyFrameConstants = {
        CMS: CMS,
        CUSTOMER: CUSTOMER,
        FLOW: FLOW,
    } as CustomHeyFrameConstants;
...
const HeyFrameInstance = new HeyFrameClass();

// Freeze InAppPurchase to prevent modifications
Object.defineProperty(HeyFrameInstance, 'InAppPurchase', { configurable: false, writable: false });

// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
export { HeyFrameClass, HeyFrameInstance };
