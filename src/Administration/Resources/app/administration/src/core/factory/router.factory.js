...
export default function createRouter(Router, View, moduleFactory, LoginService) {
    ...
    function addGlobalNavigationGuard(router) {
        ...
        router.beforeEach((to) => {
            ...
            const tokenHandler = new HeyFrame.Helper.RefreshTokenHelper();
            ...
            if (to.meta.privilege && !HeyFrame.Service('acl').can(to.meta.privilege)) {
    ...
    function convertRouteComponentToViewComponent(route) {
        const hasOwnProperty = HeyFrame.Utils.object.hasOwnProperty;
    ...
    function getViewComponent(componentName) {
        return HeyFrame.Application.view.getComponentForRoute(componentName);
    }

    function getAssetPath() {
        return HeyFrame.Context.api.assetsPath;
    }
