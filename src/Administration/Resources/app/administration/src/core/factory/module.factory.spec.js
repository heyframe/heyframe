...
const { Module, Application } = HeyFrame;
...
describe('core/factory/module.factory.js', () => {
    ...
    it('should be possible to register a module with multiple navigation entries', () => {
        ...
        expect(externalLinkNavigation.link).toBe('http://de.heyframe.com');
    });
    ...
    it('should add settings item if feature flag is active', () => {
        ...
        expect(HeyFrame.Store.get('settingsItems').settingsGroups).toEqual(expectedSettingsItem);
    });
    ...
    it('should not add settings item if feature flag is deactivated', () => {
        ...
        expect(HeyFrame.Store.get('settingsItems').settingsGroups).toEqual({});
    });
