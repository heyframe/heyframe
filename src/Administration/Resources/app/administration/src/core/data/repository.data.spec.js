...
const repositoryFactory = HeyFrame.Service('repositoryFactory');
const DEFAULT_CURRENCY = 'b7d2554b0ce847cd82f3ac9bd1c0dfca';

function mockContext() {
    return {
        apiPath: 'http://heyframe.local/api',
        apiResourcePath: 'http://heyframe.local/api/v2',
        assetsPath: 'http://heyframe.local/bundles/',
        basePath: '',
        host: 'heyframe.local',
        inheritance: false,
        installationPath: 'http://heyframe.local',
        ...
        port: 80,
        scheme: 'http',
        schemeAndHttpHost: 'http://heyframe.local',
        uri: 'http://heyframe.local/admin',
        authToken: {
...
describe('repository.data.ts', () => {
    ...
    it('should create one delete operation for multiple deletes', async () => {
        ...
        const context = HeyFrame.Context.api;
