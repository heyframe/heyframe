...
export default class Repository<EntityName extends keyof EntitySchema.Entities> {
    ...
    get schema(): EntityDefinition<any> {
        return HeyFrame.EntityDefinition.get(this.entityName);
    }

    /**
     * Sends a search request to the server to find entity ids for the provided criteria.
     */
    searchIds(criteria: Criteria, context = HeyFrame.Context.api): Promise<IdSearchResult> {
     ...
     */
    search(criteria: Criteria, context = HeyFrame.Context.api): Promise<EntityCollection<EntityName>> {
        const headers = this.buildHeaders(context);
     ...
     */
    get(id: string, context = HeyFrame.Context.api, criteria: Criteria | null = null): Promise<Entity<EntityName> | null> {
     ...
     */
    save(entity: Entity<EntityName>, context = HeyFrame.Context.api): Promise<void | AxiosResponse> {
     ...
     */
    clone(entityId: string, behavior: $TSDangerUnknownObject, context = HeyFrame.Context.api): Promise<unknown> {
        if (!entityId) {
     ...
     */
    saveAll(entities: EntityCollection<EntityName>, context = HeyFrame.Context.api): Promise<unknown> {
     ...
     * @private
     */
    sendUpserts(changeset: $TSDangerUnknownObject[], failOnError: boolean, context = HeyFrame.Context.api): Promise<void> {
     ...
     */
    assign(id: string, context = HeyFrame.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    delete(id: string, context = HeyFrame.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    syncDeleted(ids: string[], context = HeyFrame.Context.api): Promise<void> {
        const headers = this.buildHeaders(context);
     ...
     */
    create(context = HeyFrame.Context.api, id: string | null = null): Entity<EntityName> {
     ...
     */
    mergeVersion(versionId: string, context = HeyFrame.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    deleteVersion(entityId: string, versionId: string, context = HeyFrame.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    sendDeletions(queue: DeletionQueue, context = HeyFrame.Context.api): Promise<AxiosResponse[]> {
        const headers = this.buildHeaders(context);
     ...
     */
    buildHeaders(context = HeyFrame.Context.api): {
        Accept: string;
