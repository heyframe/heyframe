 ...
 *
 * @module core/data/HeyFrameError
 */
 ...
 * @memberOf module:core/data/HeyFrameError
 */
// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
export default class HeyFrameError {
    ...
    constructor({
        ...
        if (typeof code !== 'string' || code === '') {
            throw new Error('[HeyFrameError] can not identify error by code');
        }
