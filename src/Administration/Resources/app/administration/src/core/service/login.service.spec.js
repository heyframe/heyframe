...
describe('core/service/login.service.js', () => {
    beforeAll(async () => {
        ...
        HeyFrame.Service().register('userActivityService', () => {
            return {
                getLastUserActivity: () => {
    ...
    it('should login and return the bearer token', async () => {
        ...
        const auth = await loginService.loginByUsername('admin', 'heyframe');
    ...
    it('should get a new token', async () => {
        ...
        await loginService.loginByUsername('admin', 'heyframe');
    ...
    it('should set logout refresh storage key correctly', async () => {
        // Mock Router
        HeyFrame.Application.view.router = {
            currentRoute: {
                value: {
