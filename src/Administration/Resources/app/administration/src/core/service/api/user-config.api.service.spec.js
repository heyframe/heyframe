...
function newUserConfigService(client) {
    return new UserConfigService(client, createLoginService(client, HeyFrame.Context.api));
}
...
describe('userConfigService', () => {
    ...
    it('returns undefined on error and logs the error', async () => {
        ...
        const consoleSpy = jest.spyOn(HeyFrame.Utils.debug, 'error').mockImplementation(() => {});
