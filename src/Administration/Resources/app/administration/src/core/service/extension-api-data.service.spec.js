...
import { handleFactory, send } from '@heyframe-ag/meteor-admin-sdk/es/channel';
import SerializerFactory from '@heyframe-ag/meteor-admin-sdk/es/_internals/serializer';
...
describe('core/service/extension-api-data.service.ts', () => {
    it('should keep functions on entity', async () => {
        const entity = new Entity(HeyFrame.Utils.createId(), 'jest', {
            name: 'jest',
        });
    ...
    it('should update entity', async () => {
        const entity = new Entity(HeyFrame.Utils.createId(), 'jestupdate', {
            name: 'beforeupdate',
        });
        ...
        jest.spyOn(window, 'addEventListener').mockImplementationOnce((event, handler) => {
            const e = new Entity(HeyFrame.Utils.createId(), 'jestupdate', {
                name: 'beforeupdate',
            });
            ...
            const data = {
                ...
                _callbackId: HeyFrame.Utils.createId(),
            };
    ...
    it('should update collection', async () => {
        ...
        collection.add(
            new Entity(HeyFrame.Utils.createId(), 'jest', {
                id: 1,
                name: 'jest1',
            }),
        );
            ...
            mediaCollection: new EntityCollection(
                ...
                [
                    new Entity('image1', 'media', {
                        url: 'https://heyframe.com/image1.jpg',
                        tags: new EntityCollection('image1/tags', 'tag', {}, null, [
                            ...
                            new Entity('tag3', 'tag', {
                                name: 'HeyFrame Community',
                            }),
                        ]),
                    }),
                    new Entity('image2', 'media', {
                        url: 'https://heyframe.com/image2.jpg',
    ...
    it.each([
        ...
        if (env === 'prod') {
            ...
            HeyFrame.Utils.debug.warn = mock;
        } else {
            envBefore = process.env;
            process.env = {};
            HeyFrame.Utils.debug.error = mock;
        }
