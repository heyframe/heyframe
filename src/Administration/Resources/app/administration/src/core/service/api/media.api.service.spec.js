...
function getMediaApiService(client = null, loginService = null) {
    ...
    if (loginService === null) {
        loginService = createLoginService(client, HeyFrame.Context.api);
    }
...
describe('storeService', () => {
    ...
    it('test getDefaultFolderId without result', async () => {
        ...
        const spyRepository = jest.spyOn(HeyFrame.Service('repositoryFactory'), 'create').mockImplementation(() => {
            return {
                search: async () => {
