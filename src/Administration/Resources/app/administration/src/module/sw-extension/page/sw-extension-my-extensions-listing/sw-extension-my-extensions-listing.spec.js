...
import HeyFrameService from 'src/module/sw-extension/service/heyframe-extension.service';
...
const heyframeService = new HeyFrameService({}, {}, {}, {});
heyframeService.updateExtensionData = jest.fn();
        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    heyframeExtensionService: heyframeService,
                },
            },
...
describe('src/module/sw-extension/page/sw-extension-my-extensions-listing', () => {
    beforeAll(() => {
        HeyFrame.Store.get('heyframeExtensions').setMyExtensions([{ name: 'Test', installedAt: null }]);
    ...
    it('runtime management disabled should be there', async () => {
        HeyFrame.Store.get('context').app.config.settings.disableExtensionManagement = true;
    ...
    it('updateList should call update extensions', async () => {
        ...
        expect(heyframeService.updateExtensionData).toHaveBeenCalled();
    });
    ...
    it('should update the route with the new values from pagination', async () => {
        ...
        HeyFrame.Store.get('heyframeExtensions').setMyExtensions(extensions);
    ...
    it('should show a warning if the APP_URL is not setup correctly', async () => {
        ...
        HeyFrame.Store.get('context').app.config.settings.appUrlReachable = false;
