        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    heyframeExtensionService: new HeyFrameService({}, {}, {}, {}),
                    cacheApiService: {
                        clear() {
...
describe('src/module/sw-extension/component/sw-self-maintained-extension-card', () => {
    ...
    it('activateExtension should install and reload the page', async () => {
        ...
        wrapper.vm.heyframeExtensionService.activateExtension = jest.fn(() => Promise.resolve());

        wrapper.vm.clearCacheAndReloadPage = jest.fn(() => Promise.resolve());

        await wrapper.vm.activateExtension();

        expect(wrapper.vm.heyframeExtensionService.activateExtension).toHaveBeenCalled();
    ...
    it('deactivateExtension should install and reload the page', async () => {
        ...
        wrapper.vm.heyframeExtensionService.deactivateExtension = jest.fn(() => Promise.resolve());

        wrapper.vm.clearCacheAndReloadPage = jest.fn(() => Promise.resolve());

        await wrapper.vm.deactivateExtension();

        expect(wrapper.vm.heyframeExtensionService.deactivateExtension).toHaveBeenCalled();
        expect(wrapper.vm.isLoading).toBe(false);
    });
