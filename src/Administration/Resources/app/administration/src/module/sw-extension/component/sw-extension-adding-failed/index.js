...
export default {
    ...
    computed: {
        myExtensions() {
            return HeyFrame.Store.get('heyframeExtensions').myExtensions;
        },
        ...
        isRent() {
            return this.extension?.storeLicense?.variant === this.heyframeExtensionService.EXTENSION_VARIANT_TYPES.RENT;
        },
