...
describe('src/module/sw-extension/component/sw-extension-file-upload', () => {
    ...
    beforeEach(async () => {
        HeyFrame.Store.get('notification').notifications = {};
        HeyFrame.Store.get('notification').growlNotifications = {};
    });
    ...
    it('should throw an error if the upload goes wrong', async () => {
        ...
        expect(Object.keys(HeyFrame.Store.get('notification').growlNotifications)).toHaveLength(0);
        ...
        await wrapper.vm.$nextTick();
        const growlNotifications = HeyFrame.Store.get('notification').growlNotifications;
