    ...
    methods: {
        ...
        handleUpload(files) {
            ...
            return this.extensionStoreActionService
                .upload(formData)
                .then(() => {
                    HeyFrame.Service('heyframeExtensionService')
                        .updateExtensionData()
                        .then(() => {
        ...
        getUserConfig() {
            return this.userConfigRepository.search(this.userConfigCriteria, HeyFrame.Context.api).then((response) => {
                if (response.length) {
                    this.pluginUploadUserConfig = response.first();
                } else {
                    this.pluginUploadUserConfig = this.userConfigRepository.create(HeyFrame.Context.api);
        ...
        saveConfig(value) {
            ...
            this.userConfigRepository.save(this.pluginUploadUserConfig, HeyFrame.Context.api).then(() => {
                this.getUserConfig();
            });
        },
    },
