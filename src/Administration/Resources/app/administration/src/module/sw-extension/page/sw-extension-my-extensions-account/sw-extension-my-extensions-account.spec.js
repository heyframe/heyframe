        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    storeService: {
                        login: (heyframeId, password) => {
                            if (heyframeId !== 'max@muster.com') {
...
describe('src/module/sw-extension/page/sw-extension-my-extensions-account', () => {
    ...
    it('should show the login fields when not logged in', async () => {
        ...
        const heyframeIdField = wrapper.find('.sw-extension-my-extensions-account__heyframe-id-field');
        ...
        expect(heyframeIdField.isVisible()).toBe(true);
    ...
    it('should login when user clicks login', async () => {
        ...
        // get fields
        const heyframeIdField = wrapper.get('.sw-extension-my-extensions-account__heyframe-id-field input');
        const passwordField = wrapper.findByLabel('sw-extension.my-extensions.account.passwordLabel');
        const loginButton = wrapper.find('.sw-extension-my-extensions-account__login-button');

        // enter credentials
        await heyframeIdField.setValue('max@muster.com');
