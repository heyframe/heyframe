...
HeyFrame.Application.addServiceProvider('loginService', () => {
    return {
...
HeyFrame.Application.addServiceProvider('extensionStoreActionService', () => {
    return extensionStoreActionService;
});

HeyFrame.Application.addServiceProvider('heyframeExtensionService', () => {
...
HeyFrame.Application.addServiceProvider('extensionErrorService', () => {
...
async function createWrapper(extension) {
    return mount(await wrapTestComponent('sw-extension-card-bought', { sync: true }), {
        global: {
            ...
            mixins: [
                HeyFrame.Mixin.getByName('sw-extension-error'),
            ],
            stubs: {
            ...
            provide: {
                ...
                extensionErrorService: HeyFrame.Service('extensionErrorService'),
                cacheApiService: {},
                shortcutService: {
                    stopEventListener: () => {},
                    startEventListener: () => {},
...
describe('src/module/sw-extension/component/sw-extension-card-bought', () => {
    ...
    it('should display error on install and download attempt when app subscription is expired', async () => {
                        ...
                        errors: [
                            {
                                ...
                                meta: {
                                    documentationLink: 'https://docs.heyframe.com/en/heyframe-6-en',
                                },
                                status: '500',
        ...
        expect(wrapper.find('.sw-extension-card-bought__installation-failed-modal p > a').text()).toBe(
            'https://docs.heyframe.com/en/heyframe-6-en',
        );
    });
