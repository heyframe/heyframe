...
export default {
    ...
    methods: {
        async changeExtensionStatus() {
            ...
            if (!this.license || this.license.variant !== this.heyframeExtensionService.EXTENSION_VARIANT_TYPES.RENT) {
        ...
        async activateExtension() {
            try {
                ...
                await this.heyframeExtensionService.activateExtension(this.extension.name, this.extension.type);
        ...
        async deactivateExtension() {
            try {
                ...
                await this.heyframeExtensionService.deactivateExtension(this.extension.name, this.extension.type);
                this.extension.active = false;
                this.clearCacheAndReloadPage();
            } catch (e) {
                this.extension.active = true;
        ...
        async installExtension() {
            ...
            try {
                ...
                await this.heyframeExtensionService.installExtension(this.extension.name, this.extension.type);
        ...
        async cancelAndRemoveExtension() {
            try {
                ...
                // by e.g. the heyframe account and the extension already has an expiration date
                if (!this.extension.storeLicense.expirationDate) {
                    await this.heyframeExtensionService.cancelLicense(this.extension.storeLicense.id);
                }

                await this.heyframeExtensionService.removeExtension(this.extension.name, this.extension.type);
