...
export default {
    ...
    computed: {
        ...
        installedVersion() {
            const installedExtension = HeyFrame.Store.get('heyframeExtensions').myExtensions.data.find(
    ...
    methods: {
        ...
        validateHeadline() {
            if (this.headline === null || this.headline === '') {
                this.errors.headlineError = new HeyFrameError({
        ...
        validateRating() {
            if (this.rating === null || this.rating === 0) {
                this.errors.ratingError = new HeyFrameError({
                    code: 'c1051bb4-d103-4f74-8988-acbcafc7fdc3',
                });
