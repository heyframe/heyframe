...
HeyFrame.Component.register('sw-extension-config', () => import('./page/sw-extension-config'));
HeyFrame.Component.register('sw-extension-my-extensions-listing', () => import('./page/sw-extension-my-extensions-listing'));
HeyFrame.Component.register('sw-extension-my-extensions-account', () => import('./page/sw-extension-my-extensions-account'));
HeyFrame.Component.register('sw-extension-my-extensions-index', () => import('./page/sw-extension-my-extensions-index'));
HeyFrame.Component.register('sw-extension-store-landing-page', () => import('./page/sw-extension-store-landing-page'));
...
HeyFrame.Component.register('sw-extension-file-upload', () => import('./component/sw-extension-file-upload'));
HeyFrame.Component.register(
    'sw-extension-permissions-details-modal',
    () => import('./component/sw-extension-permissions-details-modal'),
);
HeyFrame.Component.register('sw-extension-card-base', () => import('./component/sw-extension-card-base'));
...
HeyFrame.Component.register('sw-extension-permissions-modal', () => import('./component/sw-extension-permissions-modal'));
HeyFrame.Component.register('sw-extension-domains-modal', () => import('./component/sw-extension-domains-modal'));
HeyFrame.Component.register(
    'sw-extension-privacy-policy-extensions-modal',
    () => import('./component/sw-extension-privacy-policy-extensions-modal'),
);
HeyFrame.Component.register('sw-extension-deactivation-modal', () => import('./component/sw-extension-deactivation-modal'));
HeyFrame.Component.register('sw-extension-removal-modal', () => import('./component/sw-extension-removal-modal'));
HeyFrame.Component.register('sw-extension-uninstall-modal', () => import('./component/sw-extension-uninstall-modal'));
HeyFrame.Component.register('sw-extension-rating-stars', () => import('./component/sw-ratings/sw-extension-rating-stars'));
HeyFrame.Component.register('sw-extension-ratings-card', () => import('./component/sw-ratings/sw-extension-ratings-card'));
HeyFrame.Component.register(
    'sw-extension-ratings-summary',
    () => import('./component/sw-ratings/sw-extension-ratings-summary'),
);
HeyFrame.Component.register('sw-extension-review', () => import('./component/sw-ratings/sw-extension-review'));
HeyFrame.Component.register(
...
HeyFrame.Component.register('sw-extension-review-reply', () => import('./component/sw-ratings/sw-extension-review-reply'));
HeyFrame.Component.extend(
...
HeyFrame.Component.register('sw-extension-adding-failed', () => import('./component/sw-extension-adding-failed'));
HeyFrame.Component.register('sw-extension-adding-success', () => import('./component/sw-extension-adding-success'));
HeyFrame.Component.register(
    'sw-extension-app-module-error-page',
    () => import('./component/sw-extension-app-module-error-page'),
);
HeyFrame.Component.register('sw-extension-app-module-page', () => import('./page/sw-extension-app-module-page'));
 ...
 * @private
 */
HeyFrame.Module.register('sw-extension', {
    type: 'core',
