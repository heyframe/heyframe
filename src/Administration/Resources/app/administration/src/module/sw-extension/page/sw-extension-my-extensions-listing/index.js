...
export default {
    ...
    inject: ['heyframeExtensionService'],
    ...
    computed: {
        isAppUrlReachable() {
            return HeyFrame.Store.get('context').app.config.settings?.appUrlReachable;
        },

        isLoading() {
            const state = HeyFrame.Store.get('heyframeExtensions');

            return state.myExtensions.loading;
        },

        myExtensions() {
            return HeyFrame.Store.get('heyframeExtensions').myExtensions.data;
        },
    ...
    methods: {
        ...
        updateList() {
            this.heyframeExtensionService.updateExtensionData();
        },
