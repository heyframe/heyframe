...
async function createWrapper() {
    ...
    return mount(await wrapTestComponent('sw-channel-products-assignment-dynamic-product-groups', { sync: true }), {
        global: {
            stubs: {
                'mt-card': {
...
describe('src/module/sw-channel/component/sw-channel-products-assignment-dynamic-product-groups', () => {
