...
import template from './sw-channel-measurement.html.twig';
import './sw-channel-measurement.scss';
...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        unitSystemLabel() {
            return this.labelUnitSystem || this.$t('sw-channel.detail.measurementSystem.labelUnitSystem');
        },

        dimensionUnitLabel() {
            return this.labelLengthUnit || this.$t('sw-channel.detail.measurementSystem.labelLengthUnit');
        },

        weightUnitLabel() {
            return this.labelWeightUnit || this.$t('sw-channel.detail.measurementSystem.labelWeightUnit');
        },

        measurementUnits() {
            return this.channel.measurementUnits;
        },
        ...
        measurementUnitSystemError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.channel, 'measurementUnits.system');
        },
        ...
        measurementLengthUnitError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.channel, 'measurementUnits.units.length');
        },
        ...
        measurementWeightUnitError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.channel, 'measurementUnits.units.weight');
        },
    },
