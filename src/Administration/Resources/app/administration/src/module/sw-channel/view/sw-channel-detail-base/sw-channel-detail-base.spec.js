...
describe('src/module/sw-channel/view/sw-channel-detail-base', () => {
    ...
    it('should have the select template field disabled', async () => {
        ...
        const selectField = wrapper.get(
            'mt-select-stub[placeholder="sw-channel.detail.productComparison.templates.placeholderSelectTemplate"]',
        );
    ...
    it('should have the select field for product export sales channel domain id disabled', async () => {
        ...
        const field = wrapper.get('.sw-channel-detail__product-comparison-domain');
    ...
    it('should have the field for product export file name disabled', async () => {
        ...
        const field = wrapper.get(
            '.mt-text-field input[placeholder="sw-channel.detail.productComparison.placeholderFileName"]',
        );
    ...
    it('should have the select field for product export encoding disabled', async () => {
        ...
        const field = wrapper.get(
            'mt-select-stub[placeholder="sw-channel.detail.productComparison.placeholderSelectEncoding"]',
        );
    ...
    it('should have the select field for product export file format disabled', async () => {
        ...
        const field = wrapper.get(
            'mt-select-stub[placeholder="sw-channel.detail.productComparison.placeholderSelectFileFormat"]',
        );
    ...
    it('should have the field for product export includeVariants disabled', async () => {
        ...
        const field = wrapper.get(
            '.mt-switch input[aria-label="sw-channel.detail.productComparison.includeVariants"]',
        );
    ...
    it('should have the select number field for product export interval disabled', async () => {
        ...
        const field = wrapper.get('[label="sw-channel.detail.productComparison.interval"]');
    ...
    it('should have the switch field for product export generateByCronjob disabled', async () => {
        ...
        const field = wrapper.get(
            '.mt-switch input[aria-label="sw-channel.detail.productComparison.generateByCronjob"]',
        );
    ...
    it('should have the entity single field for product export productStreamId disabled', async () => {
        ...
        const field = wrapper.get('.sw-channel-detail__product-comparison-product-stream');
    ...
    it('should have the field for productExport accessKey disabled', async () => {
        ...
        const field = wrapper.get('.mt-text-field input[aria-label="sw-channel.detail.productComparison.accessKey"]');
    ...
    it('should have the field for productExport accessKey disabled', async () => {
        ...
        const field = wrapper.get('.mt-text-field input[aria-label="sw-channel.detail.productComparison.accessUrl"]');
    ...
    it('should return filters from filter registry', async () => {
        ...
        if (!HeyFrame.Feature.isActive('V6_8_0_0')) {
