...
import template from './sw-channel-detail-products.html.twig';
import './sw-channel-detail-products.scss';
...
export default {
    ...
    computed: {
        ...
        productCriteria() {
            ...
            criteria.addFilter(Criteria.equals('product.visibilities.channelId', this.channel.id));
