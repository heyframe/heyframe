...
import template from './sw-channel-detail-product-comparison.html.twig';
import './sw-channel-detail-product-comparison.scss';
    ...
    methods: {
        validateTemplate() {
            const notificationValidateSuccess = {
                message: this.$tc('sw-channel.detail.productComparison.notificationMessageValidateSuccessful'),
            };
