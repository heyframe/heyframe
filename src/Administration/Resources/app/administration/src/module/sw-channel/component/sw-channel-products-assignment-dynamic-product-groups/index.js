...
import template from './sw-channel-products-assignment-dynamic-product-groups.html.twig';
import './sw-channel-products-assignment-dynamic-product-groups.scss';
    ...
    computed: {
        ...
        productStreamColumns() {
            return [
                {
                    property: 'name',
                    label: this.$tc('sw-channel.detail.productAssignmentModal.dynamicProductGroups.columnName'),
                    sortable: false,
                },
            ];
        },
