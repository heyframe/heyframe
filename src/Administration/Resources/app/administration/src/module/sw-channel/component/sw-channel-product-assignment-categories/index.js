...
import template from './sw-channel-product-assignment-categories.html.twig';
import './sw-channel-product-assignment-categories.scss';
...
export default {
    ...
    methods: {
        ...
        searchCategories(term) {
            return this.categoryRepository.search(this.categorySearchCriteria(term), HeyFrame.Context.api);
        },
        ...
        productCriteria(categories) {
            ...
            productCriteria.addFilter(
                Criteria.multi('AND', [
                    ...
                    Criteria.not('and', [
                        Criteria.equals('product.visibilities.channelId', this.channel.id),
                    ]),
                ]),
            );
        ...
        getProductFromCategories(categories) {
            return this.productRepository.search(this.productCriteria(categories), HeyFrame.Context.api);
        },
    },
};
