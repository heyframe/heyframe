...
const productMock = {
    visibilities: [
        { id: '01', productId: '101', channelId: 'apiChannelTypeId' },
        {
            id: '02',
            productId: '101',
            channelId: 'frontendChannelTypeId',
...
async function createWrapper({ channel, products } = {}) {
    repositoryFactoryDeleteMock = jest.fn(async () => {});

    const wrapper = mount(
        await wrapTestComponent('sw-channel-detail-products', {
            sync: true,
        }),
        {
            global: {
                stubs: {
                    ...
                    'sw-channel-products-assignment-modal': true,
    ...
    function getCreateButton() {
        return wrapper.findByText('button', 'sw-channel.detail.products.buttonAddProducts');
    }
...
describe('src/module/sw-channel/view/sw-channel-detail-products', () => {
    beforeEach(() => {
    ...
    it('should turn on add products modal', async () => {
        ...
        const modal = wrapper.find('sw-channel-products-assignment-modal-stub');
