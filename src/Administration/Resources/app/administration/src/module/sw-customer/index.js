...
HeyFrame.Component.register('sw-customer-list', () => import('./page/sw-customer-list'));
HeyFrame.Component.register('sw-customer-detail', () => import('./page/sw-customer-detail'));
HeyFrame.Component.register('sw-customer-create', () => import('./page/sw-customer-create'));
HeyFrame.Component.register('sw-customer-detail-base', () => import('./view/sw-customer-detail-base'));
HeyFrame.Component.register('sw-customer-detail-addresses', () => import('./view/sw-customer-detail-addresses'));
