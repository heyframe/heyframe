...
HeyFrame.Component.register('sw-settings-state-machine-list', () => import('./page/sw-settings-state-machine-list'));
HeyFrame.Component.register('sw-settings-state-machine-detail', () => import('./page/sw-settings-state-machine-detail'));
