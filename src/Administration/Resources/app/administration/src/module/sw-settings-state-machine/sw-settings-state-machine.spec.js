...
HeyFrame.Application.addServiceProvider('privileges', () => {
...
describe('src/module/sw-settings-state-machine/index.js', () => {
    ...
    it('should add privilege mapping', () => {
        const privilegesMappings = HeyFrame.Service('privileges').getPrivilegesMappings();
    ...
    it('should register components', () => {
        const componentRegistry = HeyFrame.Component.getComponentRegistry();
    ...
    it('should register module', () => {
        const module = HeyFrame.Module.getModuleRegistry().get('sw-settings-state-machine');
