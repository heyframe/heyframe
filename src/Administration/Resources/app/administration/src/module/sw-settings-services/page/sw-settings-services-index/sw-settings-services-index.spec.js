...
import { MtBanner, MtModalTrigger, MtModalAction, MtButton } from '@heyframe-ag/meteor-component-library';
...
describe('/src/module/sw-setting-services/page/sw-settings-services-index', () => {
    ...
    it('shows installed services', async () => {
        ...
        expect(hero.props('documentationLink')).toBe('https://docs.heyframe.com/services');
        expect(hero.props('feedbackLink')).toBe('https://heyframe.com/feedback');
    ...
    it('shows correct links in the footer', async () => {
        ...
        expect(documentationLink.attributes('href')).toBe('https://docs.heyframe.com/services');
        expect(tosLink.attributes('href')).toBe('https://heyframe.com/agb');
    });

    it('can grant permissions', async () => {
        HeyFrame.Service('heyframeServicesService').getServicesContext.mockImplementationOnce(async () => ({
            disabled: false,
    ...
    it('does not show grant permissions card if services are deactivated', async () => {
        HeyFrame.Service('heyframeServicesService').getInstalledServices.mockImplementationOnce(async () => []);
