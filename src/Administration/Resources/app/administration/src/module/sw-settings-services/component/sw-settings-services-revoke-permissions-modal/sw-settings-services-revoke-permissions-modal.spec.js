...
import { MtModalAction, MtModalClose, MtModal } from '@heyframe-ag/meteor-component-library';
...
describe('src/module/sw-settings-services/component/sw-settings-services-revoke-permissions-modal', () => {
    ...
    it('revokes permissions', async () => {
        ...
        HeyFrame.Service('heyframeServicesService').revokePermissions.mockImplementationOnce(() => ({
