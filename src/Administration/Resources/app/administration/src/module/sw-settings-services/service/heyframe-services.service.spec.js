...
describe('src/module/sw-settings-services/service/heyframe-services-service.ts', () => {
    it.each([
        [
            undefined,
            'en-US',
        ...
        async (sessionLanguage, apiContextLanguage, expectedLanguage) => {
            HeyFrame.Store.get('session').languageId = sessionLanguage;
            HeyFrame.Context.api.languageId = apiContextLanguage;

            const client = createHTTPClient();
            const clientMock = new MockAdapter(client);
            const loginService = createLoginService(client, HeyFrame.Context.api);
            const systemConfigService = jest.fn();
            const heyframeServicesService = new HeyFrameServicesService(client, loginService, systemConfigService);
            ...
            const installedServices = await heyframeServicesService.getInstalledServices();
    ...
    it.each([
        ...
        async (
            ...
            const servicesContext = await heyframeServicesService.getServicesContext();
    ...
    it('accepts permissions revision', async () => {
        ...
        await heyframeServicesService.acceptRevision(revision);
    ...
    it('revokes permissions', async () => {
        ...
        await heyframeServicesService.revokePermissions();
    ...
    it.each([
        ...
        if (action === 'enable') {
            await heyframeServicesService.enableAllServices();
        }
    ...
    it('returns categorized permissions', async () => {
        ...
        const categorizedPermissions = await heyframeServicesService.getCategorizedPermissions('MyCoolService');
