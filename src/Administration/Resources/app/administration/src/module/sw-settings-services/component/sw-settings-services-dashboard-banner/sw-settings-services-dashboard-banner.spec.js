...
describe('src/module/sw-settings-services/component/sw-settings-services-dashboard-banner', () => {
    ...
    beforeAll(() => {
        ...
        const loginService = createLoginService(httpClient, HeyFrame.Context.api);

        axiosMock = new MockAdapter(httpClient);

        HeyFrame.Service().register('userConfigService', () => new UserConfigService(httpClient, loginService));
    });
