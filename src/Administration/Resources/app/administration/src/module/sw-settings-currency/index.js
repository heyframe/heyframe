...
HeyFrame.Component.register('sw-settings-currency-list', () => import('./page/sw-settings-currency-list'));
HeyFrame.Component.register('sw-settings-currency-detail', () => import('./page/sw-settings-currency-detail'));
HeyFrame.Component.register('sw-settings-price-rounding', () => import('./component/sw-settings-price-rounding'));
