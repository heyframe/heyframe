...
export default {
    ...
    computed: {
        ...
        languageId() {
            return HeyFrame.Store.get('session').languageId;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.timezoneOptions = HeyFrame.Service('timezoneService').getTimezoneOptions();
            const languagePromise = new Promise((resolve) => {
                HeyFrame.Store.get('context').api.languageId = this.languageId;
        ...
        loadUser() {
            ...
            return this.userRepository.get(this.userId, HeyFrame.Context.api, this.userCriteria).then((user) => {
                this.user = user;
        ...
        async saveUser(context) {
            ...
            if (this.currentUser.id === this.user.id) {
                await HeyFrame.Service('localeHelper').setLocaleWithId(this.user.localeId);
            }
        ...
        async updateCurrentUser() {
            await this.userService.getUser().then((response) => {
                ...
                HeyFrame.Store.get('session').setCurrentUser(data);
            });
        },
        ...
        async updateAuthToken() {
            ...
            HeyFrame.Store.get('context').api.authToken.access = verifiedToken;
            const authObject = {
