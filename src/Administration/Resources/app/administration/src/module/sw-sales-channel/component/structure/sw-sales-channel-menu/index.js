...
const FlatTree = HeyFrame.Helper.FlatTreeHelper;
...
export default {
    ...
    computed: {
        ...
        salesChannelFavoritesService() {
            return HeyFrame.Service('salesChannelFavorites');
        },
    ...
    methods: {
        ...
        registerListener() {
            HeyFrame.Utils.EventBus.on('sw-sales-channel-detail-sales-channel-change', this.loadEntityData);
            HeyFrame.Utils.EventBus.on('sw-language-switch-change-application-language', this.loadEntityData);
            HeyFrame.Utils.EventBus.on('sw-sales-channel-detail-base-sales-channel-change', this.openSalesChannelModal);
            HeyFrame.Utils.EventBus.on('sw-sales-channel-list-add-new-channel', this.openSalesChannelModal);
        },

        destroyedComponent() {
            HeyFrame.Utils.EventBus.off('sw-sales-channel-detail-sales-channel-change', this.loadEntityData);
            HeyFrame.Utils.EventBus.off('sw-language-switch-change-application-language', this.loadEntityData);
            HeyFrame.Utils.EventBus.off('sw-sales-channel-detail-base-sales-channel-change', this.openSalesChannelModal);
            HeyFrame.Utils.EventBus.off('sw-sales-channel-list-add-new-channel', this.openSalesChannelModal);
        },
