...
HeyFrame.Component.register('sw-sales-channel-modal', () => import('./component/sw-sales-channel-modal'));
HeyFrame.Component.register('sw-sales-channel-modal-grid', () => import('./component/sw-sales-channel-modal-grid'));
HeyFrame.Component.register('sw-sales-channel-modal-detail', () => import('./component/sw-sales-channel-modal-detail'));
HeyFrame.Component.register('sw-sales-channel-detail-domains', () => import('./component/sw-sales-channel-detail-domains'));
HeyFrame.Component.register(
    'sw-sales-channel-detail-hreflang',
    () => import('./component/sw-sales-channel-detail-hreflang'),
);
HeyFrame.Component.register('sw-sales-channel-detail', () => import('./page/sw-sales-channel-detail'));
HeyFrame.Component.extend(
    'sw-sales-channel-create',
    'sw-sales-channel-detail',
    () => import('./page/sw-sales-channel-create'),
);
HeyFrame.Component.register('sw-sales-channel-list', () => import('./page/sw-sales-channel-list'));
HeyFrame.Component.register('sw-sales-channel-detail-base', () => import('./view/sw-sales-channel-detail-base'));
HeyFrame.Component.register('sw-sales-channel-detail-products', () => import('./view/sw-sales-channel-detail-products'));
HeyFrame.Component.register('sw-sales-channel-detail-analytics', () => import('./view/sw-sales-channel-detail-analytics'));
HeyFrame.Component.extend(
...
HeyFrame.Component.register('sw-sales-channel-menu', () => import('./component/structure/sw-sales-channel-menu'));

HeyFrame.Component.register('sw-sales-channel-measurement', () => import('./component/sw-sales-channel-measurement'));
