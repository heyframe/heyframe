...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        measurementUnitSystemError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.salesChannel, 'measurementUnits.system');
        },
        ...
        measurementLengthUnitError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.salesChannel, 'measurementUnits.units.length');
        },
        ...
        measurementWeightUnitError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.salesChannel, 'measurementUnits.units.weight');
        },
    },
