...
describe('module/sw-settings-language/page/sw-settings-language-detail', () => {
    ...
    it('should not be possible to inherit with no system language', async () => {
        ...
        wrapper.vm.language = {
            id: HeyFrame.Context.api.systemLanguageId,
        };
    ...
    it('should load entity data', async () => {
        const wrapper = await createWrapper([], HeyFrame.Context.api.systemLanguageId);
        expect(wrapper.vm.languageId).toBe(HeyFrame.Context.api.systemLanguageId);
        await flushPromises();

        expect(wrapper.vm.language.id).toBe(HeyFrame.Context.api.systemLanguageId);
    });
    ...
    it('should add an asterix to used iso codes', async () => {
        const wrapper = await createWrapper(['language.editor'], HeyFrame.Context.api.systemLanguageId, false);
        await flushPromises();
