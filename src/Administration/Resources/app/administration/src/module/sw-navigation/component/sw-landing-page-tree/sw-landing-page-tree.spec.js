    ...
    const routes = [
        {
            ...
            path: '/navigation/landingPage/:id',
        },
    ];
...
describe('src/module/sw-navigation/component/sw-landing-page-tree', () => {
    ...
    beforeEach(async () => {
        ...
        // this is normally set by the heyframe runtime
        // but needed for this unit tests because the component relies on this value.
        oldSystemLanguageId = HeyFrame.Context.api.systemLanguageId;
        HeyFrame.Context.api.systemLanguageId = '1a2b3c';
    });

    afterEach(async () => {
        HeyFrame.Context.api.systemLanguageId = oldSystemLanguageId;
    });
    ...
    it('should get right landing page url', async () => {
        ...
        expect(itemUrl).toBe('#/navigation/landingPage/1a2b');
    });
