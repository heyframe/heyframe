...
export default {
    ...
    data() {
        return {
            ...
            linkContext: 'sw.navigation.landingPageDetail',
    ...
    computed: {
        landingPagesToDelete() {
            return HeyFrame.Store.get('swCategoryDetail').landingPagesToDelete;
        },
    ...
    watch: {
        landingPagesToDelete(value) {
            ...
            HeyFrame.Store.get('swCategoryDetail').landingPagesToDelete = undefined;
        },
    ...
    methods: {
        ...
        duplicateElement(contextItem) {
            ...
            this.landingPageRepository
                .clone(contextItem.id, behavior, HeyFrame.Context.api)
                .then((clone) => {
