...
HeyFrame.Component.register('sw-product-stream-list', () => import('./page/sw-product-stream-list'));
HeyFrame.Component.register('sw-product-stream-detail', () => import('./page/sw-product-stream-detail'));
HeyFrame.Component.register('sw-product-stream-field-select', () => import('./component/sw-product-stream-field-select'));
HeyFrame.Component.register('sw-product-stream-value', () => import('./component/sw-product-stream-value'));
HeyFrame.Component.register('sw-product-stream-modal-preview', () => import('./component/sw-product-stream-modal-preview'));
