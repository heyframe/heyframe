import template from './sw-first-run-wizard-heyframe-domain.html.twig';
import './sw-first-run-wizard-heyframe-domain.scss';
...
export default {
    ...
    computed: {
        ...
        nextAction() {
            if (HeyFrame.Store.get('context').app.config.settings?.disableExtensionManagement) {
            ...
            const buttonConfig = [
                {
                    ...
                    position: 'left',
                    variant: 'secondary',
                    action: 'sw.first.run.wizard.index.heyframe.account',
                    disabled: false,
                },
                {
                    key: 'next',
