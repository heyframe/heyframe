...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    computed: {
        module() {
            return HeyFrame.Store.get('extensionSdkModules').modules.find((module) => module.id === this.id);
        },
        ...
        smartBarButtons() {
            return HeyFrame.Store.get('extensionSdkModules').smartBarButtons.filter(
