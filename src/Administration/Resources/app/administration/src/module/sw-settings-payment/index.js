...
HeyFrame.Component.register('sw-plugin-box', () => import('./component/sw-plugin-box'));
HeyFrame.Component.register(
    'sw-settings-payment-sorting-modal',
    () => import('./component/sw-settings-payment-sorting-modal'),
);
HeyFrame.Component.register('sw-payment-card', () => import('./component/sw-payment-card'));
HeyFrame.Component.register('sw-settings-payment-overview', () => import('./page/sw-settings-payment-overview'));
HeyFrame.Component.register('sw-settings-payment-detail', () => import('./page/sw-settings-payment-detail'));
