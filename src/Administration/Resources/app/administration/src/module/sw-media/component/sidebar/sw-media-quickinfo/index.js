...
const { Mixin, Context, Utils } = HeyFrame;
...
export default {
    ...
    methods: {
        ...
        fetchSpatialItemConfig() {
            ...
            this.mediaRepository.get(this.item.id, HeyFrame.Context.api).then((entity) => {
        ...
        async onSave() {
            ...
            try {
                ...
                HeyFrame.Utils.EventBus.emit('sw-media-library-item-updated', this.item.id);
            }
        },
