...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.mailTemplate = this.mailTemplateRepository.create(HeyFrame.Context.api, utils.createId());
        },
        ...
        getMailTemplate() {
            return this.mailTemplateRepository
                .get(this.mailTemplate.id, HeyFrame.Context.api, this.mailTemplateCriteria)
                .then((data) => {
