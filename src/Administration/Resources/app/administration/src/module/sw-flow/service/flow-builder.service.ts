...
const { Utils, EntityDefinition } = HeyFrame;
const { capitalizeString, camelCase, snakeCase } = HeyFrame.Utils.string;
const { ACTION, ACTION_GROUP, ACTION_TYPE, CUSTOMER_GROUP, GENERAL_GROUP, ORDER_GROUP, TAG_GROUP } = HeyFrame.Constants.FLOW;
