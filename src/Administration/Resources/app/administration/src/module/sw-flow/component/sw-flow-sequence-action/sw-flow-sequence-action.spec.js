        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    flowBuilderService: HeyFrame.Service('flowBuilderService'),
                },
            },
...
describe('src/module/sw-flow/component/sw-flow-sequence-action', () => {
    beforeEach(() => {
        ...
        HeyFrame.Store.get('swFlow').setSequences(getSequencesCollection([{ ...sequenceFixture }]));
        HeyFrame.Store.get('swFlow').triggerEvent = {
            data: {
                customer: '',
                order: '',
            },
        ...
        HeyFrame.Store.get('swFlow').triggerActions = [
            {
    ...
    it('should able to add an action', async () => {
        ...
        const sequencesState = HeyFrame.Store.get('swFlow').sequences;
    ...
    it('should show action list correctly', async () => {
        HeyFrame.Store.get('swFlow').setSequences(getSequencesCollection(sequencesFixture));
    ...
    it('should able to remove action container', async () => {
        ...
        let sequencesState = HeyFrame.Store.get('swFlow').sequences;
        ...
        sequencesState = HeyFrame.Store.get('swFlow').sequences;
    ...
    it('should set error for single select if action name is empty', async () => {
        HeyFrame.Store.get('swFlow').invalidSequences = ['2'];
    ...
    it('should remove error for after select an action name', async () => {
        ...
        let invalidSequences = HeyFrame.Store.get('swFlow').invalidSequences;
        ...
        invalidSequences = HeyFrame.Store.get('swFlow').invalidSequences;
    ...
    it('should correct label in set order state description', async () => {
        HeyFrame.Store.get('swFlow').stateMachineState = [
            {
    ...
    it('should has actions from app flow actions in actions list', async () => {
        ...
        HeyFrame.Store.get('swFlow').setAppActions([
            {
                label: 'Telegram send message',
                name: 'telegram.send.message',
                swIcon: 'regular-envelope',
