...
describe('src/module/sw-flow/component/sw-flow-sequence-condition', () => {
    beforeAll(() => {
        HeyFrame.Service().register('ruleConditionDataProviderService', () => {
            return {
    ...
    it('should able to add new trueBlock or falseBlock', async () => {
        HeyFrame.Store.get('swFlow').setSequences(
    ...
    it('should set error for single select if action name is empty', async () => {
        HeyFrame.Store.get('swFlow').invalidSequences = ['1'];
    ...
    it('should be able to change the rule', async () => {
        ...
        HeyFrame.Store.get('swFlow').setSequences(getSequencesCollection([{ ...sequence }]));
    ...
    it('should disable the rule if it is restricted', async () => {
        ...
        HeyFrame.Store.get('swFlow').restrictedRules = 'someRestrictedRule';
