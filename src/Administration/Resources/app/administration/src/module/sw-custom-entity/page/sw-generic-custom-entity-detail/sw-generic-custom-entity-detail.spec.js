...
HeyFrame.Component.register('sw-generic-custom-entity-detail', swGenericCustomEntityDetail);
...
async function createWrapper({ activeTab = 'main', routeId = null, entityName = testEntityName } = {}) {
    return mount(await HeyFrame.Component.build('sw-generic-custom-entity-detail'), {
        global: {
            stubs: {
                'sw-page': {
                    template:
