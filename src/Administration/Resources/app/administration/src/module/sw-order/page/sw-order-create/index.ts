...
const { Context, Store, Mixin } = HeyFrame;
...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    methods: {
        ...
        saveFinish(): void {
            ...
            HeyFrame.Store.get('context').api.languageId =
                localStorage.getItem('sw-admin-current-language') || HeyFrame.Defaults.systemLanguageId;
