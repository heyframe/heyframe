...
const { Store, Mixin, Utils } = HeyFrame;
const { Criteria } = HeyFrame.Data;
const { array } = Utils;
const ApiService = HeyFrame.Classes.ApiService;
...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            HeyFrame.Store.get('heyframeApps').selectedIds = this.orderId ? [this.orderId] : [];
        ...
        async beforeDestroyComponent() {
            if (this.hasNewVersionId) {
                ...
                Store.get('swOrderDetail').versionContext = HeyFrame.Context.api;
