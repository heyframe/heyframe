...
const { EntityDefinition, Mixin, Store } = HeyFrame;
...
export default {
    ...
    methods: {
        ...
        onEditAddress(id) {
            ...
            const currentAddress = this.addressRepository.create(HeyFrame.Context.api, id);
        ...
        onSaveAddress() {
            ...
            const address =
                ...
                this.addressRepository.create(HeyFrame.Context.api, this.currentAddress.id);
        ...
        getCustomer() {
            ...
            return this.customerRepository
                .get(this.orderCustomer.customerId, HeyFrame.Context.api, this.customerCriteria)
                .then((customer) => {
