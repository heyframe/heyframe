    ...
    methods: {
        ...
        openDocument(documentId, documentDeepLink, fileType) {
            this.documentService
                .getDocument(documentId, documentDeepLink, HeyFrame.Context.api, true, fileType)
                .then((response) => {
                    if (response.data) {
        ...
        async onCreateDocument(params, additionalAction, referencedDocumentId = null, file = null) {
            ...
            try {
                ...
                if (params.documentMediaFileId) {
                    const documentData = await this.documentRepository.get(documentId, HeyFrame.Context.api);
                ...
                if (additionalAction === 'download') {
                    ...
                    this.documentRepository.get(documentId, HeyFrame.Context.api, criteria).then((documentData) => {
                        if (!documentData) {
                            return;
                        }
