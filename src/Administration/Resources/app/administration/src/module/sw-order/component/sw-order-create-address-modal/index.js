...
const { Mixin, Store, Service } = HeyFrame;
    ...
    methods: {
        ...
        async getCustomerAddresses() {
            ...
            try {
                ...
                await HeyFrame.Store.get('error').resetApiErrors();
            } catch {
        ...
        async saveCurrentAddress() {
            ...
            if (!this.isValidCompanyField) {
                const companyError = new HeyFrame.Classes.HeyFrameError({
                    code: 'c1051bb4-d103-4f74-8988-acbcafc7fdc3',
                });

                await HeyFrame.Store.get('error').addApiError({
