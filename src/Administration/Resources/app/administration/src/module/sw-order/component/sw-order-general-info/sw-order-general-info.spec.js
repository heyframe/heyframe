            ...
            provide: {
                ...
                repositoryFactory: {
                    create(entityName) {
                        if (entityName !== 'order') {
                            return {
                                search: () => Promise.resolve(new EntityCollection('', '', HeyFrame.Context.api, null)),
                                delete: deleteFn,
                                assign: assignFn,
                            };
                        }
                        ...
                        return {
                            search: () =>
                                Promise.resolve(new EntityCollection('', 'order', HeyFrame.Context.api, null, [orderMock])),
                            delete: deleteFn,
                            assign: assignFn,
                        };
                    },
