    ...
    methods: {
        ...
        setEmailTemplateAccordingToDocumentType() {
            ...
            this.mailTemplateRepository
                .search(this.mailTemplateCriteria, { ...HeyFrame.Context.api, languageId: this.order.languageId })
                .then((result) => {
        ...
        onSendDocument() {
            ...
            const apiContext = {
                ...
                languageId: this.order.languageId || HeyFrame.Context.api.languageId,
            };
