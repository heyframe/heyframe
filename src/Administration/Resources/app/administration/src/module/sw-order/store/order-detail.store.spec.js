...
describe('src/module/sw-order/state/order-detail.store', () => {
    const state = HeyFrame.Store.get('swOrderDetail');
    ...
    it('should be able to setOrder', () => {
        ...
        HeyFrame.Store.get('swOrderDetail').order = newOrder;

        expect(state.order).toEqual(newOrder);
    });

    it('should be able to setLoading', () => {
        HeyFrame.Store.get('swOrderDetail').setLoading([
            'order',
            true,
        ]);

        expect(state.loading.order).toBe(true);
        expect(HeyFrame.Store.get('swOrderDetail').isLoading).toBe(true);
    });

    it('should be able to setSavedSuccessful', () => {
        HeyFrame.Store.get('swOrderDetail').savedSuccessful = true;
    ...
    it('should be able to setVersionContext', () => {
        ...
        HeyFrame.Store.get('swOrderDetail').versionContext = versionContext;

        expect(state.versionContext).toEqual(versionContext);
    });

    it('should be able to setEditing', () => {
        HeyFrame.Store.get('swOrderDetail').editing = true;

        expect(state.editing).toBe(true);
        expect(HeyFrame.Store.get('swOrderDetail').isEditing).toBe(true);
    });
    ...
    it('should set order address ids when provided valid address info', () => {
        ...
        HeyFrame.Store.get('swOrderDetail').setOrderAddressIds(addressIdInfo);
    ...
    it('should update customerAddressId when orderAddressId and type match', () => {
        ...
        HeyFrame.Store.get('swOrderDetail').setOrderAddressIds(initialAddressIdInfo);
        HeyFrame.Store.get('swOrderDetail').setOrderAddressIds(updatedAddressIdInfo);
    ...
    it('should remove order address id when orderAddressId equals customerAddressId and type match', () => {
        ...
        HeyFrame.Store.get('swOrderDetail').setOrderAddressIds(removalAddressIdInfo);
        expect(state.orderAddressIds).toEqual([]);
    });
});
