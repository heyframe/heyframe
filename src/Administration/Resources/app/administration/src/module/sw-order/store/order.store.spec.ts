...
describe('src/module/sw-order/store/order.store', () => {
    const store = HeyFrame.Store.get('swOrder');
    ...
    beforeAll(() => {
        ...
        // eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
        HeyFrame.Service().register('checkoutStoreService', () => {
            return {
                checkout: checkoutMock,
            } as unknown as CheckoutStoreService;
        });
        // eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
        HeyFrame.Service().register('orderStateMachineService', () => {
            return {
    ...
    beforeEach(() => {
        HeyFrame.Store.get('swOrder').$reset();
    });
