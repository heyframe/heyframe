...
HeyFrame.Component.register('sw-dashboard-statistics', () => import('./component/sw-dashboard-statistics'));
HeyFrame.Component.register('sw-dashboard-index', () => import('./page/sw-dashboard-index'));
 ...
 * @private
 */
HeyFrame.Module.register('sw-dashboard', {
    type: 'core',
    name: 'dashboard',
