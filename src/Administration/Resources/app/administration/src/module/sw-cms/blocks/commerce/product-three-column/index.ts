 ...
 */
HeyFrame.Component.register('sw-cms-preview-product-three-column', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-block-product-three-column', () => import('./component'));
