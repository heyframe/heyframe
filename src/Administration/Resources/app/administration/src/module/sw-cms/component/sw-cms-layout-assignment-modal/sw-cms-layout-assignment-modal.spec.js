...
async function createWrapper(layoutType = 'product_list', systemConfigApiServiceOverrides = {}) {
    return mount(
        ...
        }),
        {
            ...
            props: {
                page: {
                    categories: new EntityCollection(null, null, HeyFrame.Context.api, new Criteria(1, 25), mockCategories),
                    products: new EntityCollection(null, null, HeyFrame.Context.api, new Criteria(1, 25), mockProducts),
