...
const heyframeStoreGetter = HeyFrame.Store.get;

describe('module/sw-cms/page/sw-cms-detail', () => {
    beforeEach(async () => {
        HeyFrame.Store.get = heyframeStoreGetter;
        HeyFrame.Store.get('cmsPage').$reset();
    ...
    it('should get preview entity for categories', async () => {
        ...
        const State = HeyFrame.Store._rootState.state.value.cmsPage;
    ...
    it('should set the currentPageType in the cmsPage', async () => {
        ...
        let State = HeyFrame.Store._rootState.state.value.cmsPage;
        ...
        State = HeyFrame.Store._rootState.state.value.cmsPage;
    ...
    it('should reset all related stores', async () => {
        ...
        HeyFrame.Store.get = jest.fn().mockImplementation((storeName) => {
            switch (storeName) {
                case 'cmsPage':
                ...
                default:
                    return heyframeStoreGetter(storeName);
            }
        });
