 ...
 */
HeyFrame.Component.register('sw-cms-el-preview-buy-box', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-el-config-buy-box', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-el-buy-box', () => import('./component'));
...
HeyFrame.Service('cmsService').registerCmsElement({
    ...
    defaultConfig: {
        product: {
            ...
            entity: {
                name: 'product',
                criteria: new HeyFrame.Data.Criteria(1, 25).addAssociation('deliveryMedia'),
            },
        },
        alignment: {
            source: 'static',
