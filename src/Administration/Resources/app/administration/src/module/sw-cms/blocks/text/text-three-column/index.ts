 ...
 */
HeyFrame.Component.register('sw-cms-preview-text-three-column', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-block-text-three-column', () => import('./component'));
