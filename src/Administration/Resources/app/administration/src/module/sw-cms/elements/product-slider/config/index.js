...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.productCollection = new EntityCollection('/product', 'product', HeyFrame.Context.api);
        ...
        loadProductStream() {
            this.productStreamRepository
                .get(this.element.config.products.value, HeyFrame.Context.api, new Criteria(1, 25))
                .then((result) => {
