...
HeyFrame.Context.api.assetsPath = MOCK_ASSET_PATH;

const sliderItemsConfigMock = [
    {
        mediaId: '1',
        mediaUrl: 'http://heyframe.com/image1.jpg',
    },
    {
        mediaId: '2',
        mediaUrl: 'http://heyframe.com/image2.jpg',
    },
    {
        mediaId: '3',
        mediaUrl: 'http://heyframe.com/image3.jpg',
    },
];
...
const sliderItemsDataMock = [
    {
        media: {
            id: '1',
            url: 'http://heyframe.com/image1.jpg',
        },
    },
    {
        media: {
            id: '2',
            url: 'http://heyframe.com/image2.jpg',
        },
    },
    {
        media: {
            id: '3',
            url: 'http://heyframe.com/image3.jpg',
        },
    },
];
    ...
    return mount(
        ...
        }),
        {
            global: {
                sync: false,
                provide: {
                    cmsService: HeyFrame.Service('cmsService'),
                },
            },
            props: {
                element: {
...
describe('src/module/sw-cms/elements/image-slider/component', () => {
    ...
    it('setSliderArrowItem should work correctly', async () => {
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heyframe.com/image1.jpg');
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heyframe.com/image3.jpg');
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heyframe.com/image2.jpg');
    });
