...
const types = HeyFrame.Utils.types;
...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        demoContext() {
            if (this.demoEntity === 'product') {
                return { ...HeyFrame.Context.api, inheritance: true };
            }
    ...
    methods: {
        ...
        openSectionSettings(sectionIndex: number) {
            HeyFrame.Store.get('cmsPage').setSection(this.page.sections![sectionIndex]);
        ...
        onSectionDelete(sectionId: string) {
            HeyFrame.Store.get('cmsPage').removeSelectedSection();
        ...
        onBlockDelete(block: Entity<'cms_block'>, section: Entity<'cms_section'> | null) {
            ...
            if (this.selectedBlock && this.selectedBlock.id === block.id) {
                HeyFrame.Store.get('cmsPage').removeSelectedBlock();
            }
