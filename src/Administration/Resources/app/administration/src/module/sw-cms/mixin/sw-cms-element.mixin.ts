    ...
    defineComponent({
        ...
        computed: {
            ...
            category(): Entity | null {
                try {
                    return HeyFrame.Store.get('swCategoryDetail')?.category as Entity;
                } catch {
                    return null;
                }
            },
            ...
            product(): Entity | null {
                try {
                    return HeyFrame.Store.get('swProductDetail')?.product as Entity;
                } catch {
                    return null;
                }
            },
            ...
            landingPage() {
                try {
                    return HeyFrame.Store.get('swCategoryDetail')?.landingPage as Entity;
                } catch {
                    return null;
                }
            },
        ...
        methods: {
            ...
            getDefaultTranslations(entity: Entity) {
                return entity.translations?.find((translation) => {
                    return translation.languageId === HeyFrame.Context.api.systemLanguageId;
                });
            },
        },
    }),
