 ...
 */
HeyFrame.Component.register('sw-cms-el-preview-product-slider', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-el-config-product-slider', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-el-product-slider', () => import('./component'));
...
HeyFrame.Service('cmsService').registerCmsElement({
    ...
    defaultConfig: {
        products: {
            ...
            entity: {
                name: 'product',
                criteria: new HeyFrame.Data.Criteria(1, 25).addAssociation('cover'),
            },
        },
        title: {
            source: 'static',
