 ...
 */
HeyFrame.Component.register('sw-cms-preview-image-four-column', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
HeyFrame.Component.register('sw-cms-block-image-four-column', () => import('./component'));
    ...
    slots: {
        ...
        right: {
            ...
            default: {
                ...
                data: {
                    media: {
                        value: HeyFrame.Constants.CMS.MEDIA.previewMountain,
                        source: 'default',
                    },
                },
            },
