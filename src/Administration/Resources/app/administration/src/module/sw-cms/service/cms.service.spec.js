...
describe('module/sw-cms/service/cms.service.spec.js', () => {
    const cmsService = HeyFrame.Service('cmsService');
    ...
    const enrichData = {
        'entity-media-0': new HeyFrame.Data.EntityCollection(
            '/media',
            'media',
            null,
            null,
        ...
        'entity-media-1': new HeyFrame.Data.EntityCollection(
            '/media',
            'media',
            null,
            null,
    ...
    describe('collect', () => {
        it('adds multiple entity data when cms element defaultConfig properties have the same entity', async () => {
            ...
            const entityMedia2Criteria = new HeyFrame.Data.Criteria(1, 25);
            entityMedia2Criteria.setIds([5]);

            const entityMedia3Criteria = new HeyFrame.Data.Criteria(1, 25);
        ...
        it('uses given search criteria of cms element', async () => {
            const criteria = new HeyFrame.Data.Criteria(1, 10);
            criteria.setIds(['123']);
            // cms element components call the initElementConfig() function from cms-service mixin
            // to add the defaultConfig properties to the config root level
            const element = {
    ...
    describe('getEntityMappingTypes', () => {
        const entityDefinition = HeyFrame.EntityDefinition;
    ...
    describe('getCollectFunction', () => {
        ...
        it('flattens array entityData values', async () => {
            ...
            const entityCriteria = new HeyFrame.Data.Criteria(1, 25);
