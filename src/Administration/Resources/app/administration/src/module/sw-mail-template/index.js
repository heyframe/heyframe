...
HeyFrame.Component.register('sw-mail-template-list', () => import('./component/sw-mail-template-list'));
HeyFrame.Component.register('sw-mail-header-footer-list', () => import('./component/sw-mail-header-footer-list'));
HeyFrame.Component.register('sw-mail-template-detail', () => import('./page/sw-mail-template-detail'));
HeyFrame.Component.extend(
    'sw-mail-template-create',
    'sw-mail-template-detail',
    () => import('./page/sw-mail-template-create'),
);
HeyFrame.Component.register('sw-mail-template-index', () => import('./page/sw-mail-template-index'));
HeyFrame.Component.register('sw-mail-header-footer-detail', () => import('./page/sw-mail-header-footer-detail'));
HeyFrame.Component.extend(
