...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            criteria.addAssociation('channels').addSorting(Criteria.sort('name'));
        ...
        getListColumns() {
            return [
                ...
                {
                    property: 'channels.name',
                    dataIndex: 'channels.name',
                    label: 'sw-mail-header-footer.list.columnChannels',
                    allowResize: true,
                    sortable: false,
                },
            ];
        ...
        getChannelsString(item) {
            ...
            item.channels.forEach((channel) => {
                ...
                channels += `${channel.translated.name}`;
            });
        ...
        checkCanBeDeleted(mailHeaderFooter) {
            return !mailHeaderFooter.channels.length;
        },
