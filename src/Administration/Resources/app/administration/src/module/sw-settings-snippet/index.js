...
HeyFrame.Component.register('sw-settings-snippet-set-list', () => import('./page/sw-settings-snippet-set-list'));
HeyFrame.Component.register('sw-settings-snippet-list', () => import('./page/sw-settings-snippet-list'));
HeyFrame.Component.register('sw-settings-snippet-detail', () => import('./page/sw-settings-snippet-detail'));
HeyFrame.Component.extend(
    'sw-settings-snippet-create',
    'sw-settings-snippet-detail',
    () => import('./page/sw-settings-snippet-create'),
);
HeyFrame.Component.register('sw-settings-snippet-sidebar', () => import('./component/sidebar/sw-settings-snippet-sidebar'));
