...
HeyFrame.Component.register('sw-bulk-edit-product', () => import('./page/sw-bulk-edit-product'));
HeyFrame.Component.register('sw-bulk-edit-order', () => import('./page/sw-bulk-edit-order'));
HeyFrame.Component.register('sw-bulk-edit-customer', () => import('./page/sw-bulk-edit-customer'));
...
HeyFrame.Component.register('sw-bulk-edit-change-type', () => import('./component/sw-bulk-edit-change-type'));
HeyFrame.Component.register(
...
HeyFrame.Component.register('sw-bulk-edit-product-media', () => import('./component/product/sw-bulk-edit-product-media'));
HeyFrame.Component.extend(
...
HeyFrame.Component.register('sw-bulk-edit-save-modal', () => import('./component/sw-bulk-edit-save-modal'));
HeyFrame.Component.register('sw-bulk-edit-save-modal-confirm', () => import('./component/sw-bulk-edit-save-modal-confirm'));
HeyFrame.Component.register('sw-bulk-edit-save-modal-process', () => import('./component/sw-bulk-edit-save-modal-process'));
HeyFrame.Component.register('sw-bulk-edit-save-modal-success', () => import('./component/sw-bulk-edit-save-modal-success'));
HeyFrame.Component.register('sw-bulk-edit-save-modal-error', () => import('./component/sw-bulk-edit-save-modal-error'));
