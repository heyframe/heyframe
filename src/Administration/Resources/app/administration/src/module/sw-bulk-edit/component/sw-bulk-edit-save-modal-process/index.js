...
const { chunk: chunkArray } = HeyFrame.Utils.array;
...
export default {
    ...
    computed: {
        ...
        documentTypes() {
            return HeyFrame.Store.get('swBulkEdit')?.orderDocuments?.download?.value;
        },

        documentTypeConfigs() {
            return HeyFrame.Store.get('swBulkEdit').documentTypeConfigs;
        },
