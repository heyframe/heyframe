...
const selectedOrderId = HeyFrame.Utils.createId();
...
describe('src/module/sw-bulk-edit/page/sw-bulk-edit-order', () => {
    ...
    beforeEach(async () => {
        ...
        HeyFrame.Store.get('swBulkEdit').$reset();
        HeyFrame.Store.get('swBulkEdit').selectedIds = [selectedOrderId];
    });
    ...
    it('should call fetchStatusOptions when component created', async () => {
        ...
        const { liveVersionId } = HeyFrame.Context.api;
