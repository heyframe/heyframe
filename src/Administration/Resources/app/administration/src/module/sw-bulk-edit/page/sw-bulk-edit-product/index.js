...
const { chunk } = HeyFrame.Utils.array;
const { cloneDeep } = HeyFrame.Utils.object;
const { convert } = HeyFrame.Utils.unitConversion;
...
export default {
    ...
    computed: {
        ...
        selectedIds() {
            return HeyFrame.Store.get('swBulkEdit').selectedIds;
        },
    ...
    methods: {
        ...
        getParentProduct() {
            return this.productRepository
                .get(this.$route.params.parentId, HeyFrame.Context.api, this.productCriteria)
                .then((parentProduct) => {
                    parentProduct.stock = null;
                    HeyFrame.Store.get('swProductDetail').parentProduct = parentProduct;
