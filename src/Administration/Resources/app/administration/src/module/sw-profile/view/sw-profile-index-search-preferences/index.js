...
const { Module, Store, Mixin } = HeyFrame;
...
export default {
    ...
    computed: {
        ...
        adminEsEnable() {
            return HeyFrame.Context.app.adminEsEnable ?? false;
        },
    },
    ...
    methods: {
        ...
        async getMinSearchTermLength() {
            ...
            try {
                ...
                HeyFrame.Store.get('swProfile').setMinSearchTermLength(minSearchTermLength);
            } catch (error) {
        ...
        addEventListeners() {
            HeyFrame.Utils.EventBus.on('sw-search-preferences-modal-close', this.getDataSource);
        },

        removeEventListeners() {
            HeyFrame.Utils.EventBus.off('sw-search-preferences-modal-close', this.getDataSource);
        },
