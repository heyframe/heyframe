                ...
                repositoryFactory: {
                    create: (entityName) => {
                        ...
                        return {
                            ...
                            search: () => Promise.resolve(new EntityCollection('', '', HeyFrame.Context.api, null, [], 0)),
                            getSyncChangeset: () => ({
...
describe('src/module/sw-profile/page/sw-profile-index', () => {
    ...
    it('should be able to change new password', async () => {
        ...
        wrapper.vm.onChangeNewPassword('HeyFrame');

        expect(wrapper.vm.newPassword).toBe('HeyFrame');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        wrapper.vm.onChangeNewPasswordConfirm('HeyFrame');

        expect(wrapper.vm.newPasswordConfirm).toBe('HeyFrame');
    });
