...
describe('src/module/sw-profile/view/sw-profile-index-general', () => {
    it('should be able to change new password', async () => {
        ...
        await changeNewPasswordField.setValue('HeyFrame');
        await changeNewPasswordField.trigger('input');
        await flushPromises();

        expect(wrapper.emitted('new-password-change')[0][0]).toBe('HeyFrame');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        await changeNewPasswordConfirmField.setValue('HeyFrame');
        await changeNewPasswordConfirmField.trigger('input');
        await flushPromises();

        expect(wrapper.emitted('new-password-confirm-change')[0][0]).toBe('HeyFrame');
    });
