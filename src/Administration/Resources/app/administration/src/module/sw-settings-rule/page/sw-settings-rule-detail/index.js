...
const { Component, Mixin, Context } = HeyFrame;
...
export default {
    ...
    methods: {
        ...
        onChangeLanguage(languageId) {
            HeyFrame.Store.get('context').api.languageId = languageId;
        ...
        onDuplicate() {
            return this.onSave().then(() => {
                ...
                return this.ruleRepository.clone(this.rule.id, behaviour, HeyFrame.Context.api).then((duplicatedData) => {
                    this.$router.push({
                        name: 'sw.settings.rule.detail',
