...
HeyFrame.Component.register('sw-settings-rule-category-tree', () => import('./component/sw-settings-rule-category-tree'));
HeyFrame.Component.extend(
    'sw-settings-rule-tree-item',
    'sw-tree-item',
    () => import('./component/sw-settings-rule-tree-item'),
);
HeyFrame.Component.extend('sw-settings-rule-tree', 'sw-tree', () => import('./component/sw-settings-rule-tree'));
HeyFrame.Component.register('sw-settings-rule-list', () => import('./page/sw-settings-rule-list'));
HeyFrame.Component.register('sw-settings-rule-detail', () => import('./page/sw-settings-rule-detail'));
HeyFrame.Component.register('sw-settings-rule-detail-base', () => import('./view/sw-settings-rule-detail-base'));
HeyFrame.Component.register(
