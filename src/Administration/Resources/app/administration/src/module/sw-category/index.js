...
HeyFrame.Component.register('sw-category-tree', () => import('./component/sw-category-tree'));
...
HeyFrame.Component.register('sw-category-view', () => import('./component/sw-category-view'));
HeyFrame.Component.register('sw-category-link-settings', () => import('./component/sw-category-link-settings'));
HeyFrame.Component.register('sw-category-layout-card', () => import('./component/sw-category-layout-card'));
HeyFrame.Component.register('sw-category-detail-menu', () => import('./component/sw-category-detail-menu'));
HeyFrame.Component.register('sw-category-seo-form', () => import('./component/sw-category-seo-form'));
HeyFrame.Component.register('sw-category-entry-point-card', () => import('./component/sw-category-entry-point-card'));
HeyFrame.Component.register('sw-category-entry-point-modal', () => import('./component/sw-category-entry-point-modal'));
...
HeyFrame.Component.register('sw-category-detail-cms', () => import('./view/sw-category-detail-cms'));
HeyFrame.Component.register('sw-category-detail-custom-entity', () => import('./view/sw-category-detail-custom-entity'));
...
HeyFrame.Component.register('sw-category-detail-products', () => import('./view/sw-category-detail-products'));
HeyFrame.Component.register('sw-category-detail-seo', () => import('./view/sw-category-detail-seo'));
