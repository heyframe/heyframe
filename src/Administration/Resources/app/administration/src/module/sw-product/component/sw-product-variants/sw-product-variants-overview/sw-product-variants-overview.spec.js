...
describe('src/module/sw-product/component/sw-product-variants/sw-product-variants-overview', () => {
    beforeEach(() => {
        ...
        const productMediaCollection = new HeyFrame.Data.EntityCollection(
    ...
    it('should contain a currencyColumns computed property', async () => {
        ...
        HeyFrame.Store.get('swProductDetail').currencies = undefined;

        expect(wrapper.vm.currencyColumns).toEqual([]);

        HeyFrame.Store.get('swProductDetail').currencies = [
            {
                id: 'b7d2554b0ce847cd82f3ac9bd1c0dfca',
                name: 'Euro',
    ...
    it('should correctly create a new product_media entity when media inheritance is removed', async () => {
        ...
        const mockVariant = {
            id: 'variant-id-1',
            media: new HeyFrame.Data.EntityCollection('/product/variant-id-1/media', 'product_media', HeyFrame.Context.api),
        };

        const storeProductMedia = HeyFrame.Store.get('swProductDetail').product.media.first();
        ...
        expect(mockProductMediaRepositoryCreate).toHaveBeenCalledWith(HeyFrame.Context.api);
