...
const frontendId = uuid.get('frontend');
...
describe('src/module/sw-product/view/sw-product-detail-seo', () => {
    ...
    it('should update product main categories correctly', async () => {
        HeyFrame.Store.get('swProductDetail').product = { mainCategories: [] };
    ...
    it('should update main category when restore inheritance of Seo Category from variant', async () => {
        ...
        HeyFrame.Store.get('swProductDetail').product = { ...productInheritedCategoryDataMock.product };
        ...
        expect(selectStoreFront.text()).toBe('Frontend');
        await selectStoreFront.trigger('click');
        await flushPromises();

        selectionText = channelSwitch.find('.sw-entity-single-select__selection-text');
        expect(selectionText.text()).toBe('Frontend');
        expect(wrapper.vm.currentChannelId).toEqual(frontendId);
    ...
    it('should create new main category when changing the value', async () => {
        ...
        const productDetailStore = HeyFrame.Store.get('swProductDetail');
