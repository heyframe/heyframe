...
describe('src/module/sw-product/view/sw-product-detail-specifications', () => {
    beforeEach(async () => {
        ...
        HeyFrame.Store.get('swProductDetail').customFieldSets = [];
    });
    ...
    it('should hide item fields in Selling Packaging card when advanced mode is off', async () => {
        const wrapper = await createWrapper();
        const advancedModeSetting = HeyFrame.Store.get('swProductDetail').advancedModeSetting;
    ...
    it('should hide Measurement card when measurement mode is unchecked', async () => {
        const wrapper = await createWrapper();
        const modeSettings = HeyFrame.Store.get('swProductDetail').modeSettings;

        HeyFrame.Store.get('swProductDetail').modeSettings = [
