...
const { uniqBy } = HeyFrame.Utils.array;
...
export default {
    ...
    computed: {
        ...
        variants() {
            return HeyFrame.Store.get('swProductDetail').variants;
        },
    ...
    methods: {
        ...
        loadOptions() {
            return new Promise((resolve) => {
                ...
                this.productRepository.get(this.product.id, HeyFrame.Context.api, criteria).then((product) => {
