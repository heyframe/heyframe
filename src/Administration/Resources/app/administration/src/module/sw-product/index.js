...
HeyFrame.Component.register('sw-product-basic-form', () => import('./component/sw-product-basic-form'));
HeyFrame.Component.register('sw-product-deliverability-form', () => import('./component/sw-product-deliverability-form'));
...
HeyFrame.Component.register('sw-product-media-form', () => import('./component/sw-product-media-form'));
HeyFrame.Component.register('sw-product-download-form', () => import('./component/sw-product-download-form'));
HeyFrame.Component.register('sw-product-visibility-detail', () => import('./component/sw-product-visibility-detail'));
HeyFrame.Component.register(
...
HeyFrame.Component.register('sw-product-add-properties-modal', () => import('./component/sw-product-add-properties-modal'));
HeyFrame.Component.register('sw-product-detail-base', () => import('./view/sw-product-detail-base'));
HeyFrame.Component.register('sw-product-detail-specifications', () => import('./view/sw-product-detail-specifications'));
HeyFrame.Component.register('sw-product-detail-context-prices', () => import('./view/sw-product-detail-context-prices'));
