...
export default {
    ...
    computed: {
        ...
        isNotSystemLanguage() {
            return HeyFrame.Context.api.systemLanguageId !== HeyFrame.Context.api.languageId;
        },
    ...
    methods: {
        ...
        onDuplicateProfile(item) {
            ...
            return this.profileRepository
                .clone(item.id, behavior, HeyFrame.Context.api)
                .then((clone) => {
        ...
        saveSelectedProfile() {
            ...
            return this.profileRepository
                .save(this.selectedProfile, HeyFrame.Context.api)
                .then(() => {
                    this.showProfileEditModal = false;
                    this.selectedProfile = null;
