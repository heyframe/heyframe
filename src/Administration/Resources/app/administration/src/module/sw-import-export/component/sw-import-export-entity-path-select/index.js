...
const { debounce, get, flow } = HeyFrame.Utils;
...
export default {
    ...
    computed: {
        ...
        actualPathPrefix() {
            ...
            this.actualPathParts.forEach((part) => {
                ...
                const definition = HeyFrame.EntityDefinition.get(entity);
        ...
        currentEntity() {
            ...
            let actualDefinition = HeyFrame.EntityDefinition.get(this.entityType);
            ...
            pathParts.forEach((propertyName) => {
                ...
                entityFound = HeyFrame.EntityDefinition.has(entity);

                if (entityFound) {
                    actualDefinition = HeyFrame.EntityDefinition.get(entity);
                }
            });
        ...
        options() {
            ...
            if (isCustomField) {
                ...
                definition = HeyFrame.EntityDefinition.get(this.currentEntity);
            }
    ...
    methods: {
        ...
        processTranslations({ definition, options, properties, path }) {
            ...
            const translationDefinition = HeyFrame.EntityDefinition.get(translationProperty.entity);
        ...
        processTransactions({ definition, options, properties, path }) {
            ...
            const transactionDefinition = HeyFrame.EntityDefinition.get(transactionsProperty.entity);
        ...
        processDeliveries({ definition, options, properties, path }) {
            ...
            const deliveryDefinition = HeyFrame.EntityDefinition.get(deliveryProperty.entity);
