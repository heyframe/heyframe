...
export default {
    ...
    methods: {
        createdComponent() {
            HeyFrame.Context.api.languageId = HeyFrame.Context.api.systemLanguageId;

            if (this.$route.params.id) {
                this.country = this.countryRepository.create(HeyFrame.Context.api, this.$route.params.id);
                this.country.customerTax = {
                    amount: 0,
                    currencyId: HeyFrame.Context.app.systemCurrencyId,
                    enabled: false,
                };
