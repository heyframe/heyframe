    ...
    methods: {
        ...
        onDeleteCountryStates() {
            ...
            return this.countryStateRepository
                .syncDeleted(countryStateIds, HeyFrame.Context.api)
                .then(() => {
                    this.$refs.countryStateGrid.resetSelection();
                    this.refreshCountryStateList();
                })
        ...
        onAddCountryState() {
            this.currentCountryState = this.countryStateRepository.create(HeyFrame.Context.api);
        },
        ...
        onClickCountryState(item) {
            ...
            const copy = this.countryStateRepository.create(HeyFrame.Context.api, item.id);
            copy._isNew = false;
