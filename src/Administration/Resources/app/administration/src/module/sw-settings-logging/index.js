...
HeyFrame.Component.register('sw-settings-logging-list', () => import('./page/sw-settings-logging-list'));
HeyFrame.Component.register('sw-settings-logging-entry-info', () => import('./component/sw-settings-logging-entry-info'));
