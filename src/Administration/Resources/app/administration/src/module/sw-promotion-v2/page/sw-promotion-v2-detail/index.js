    ...
    methods: {
        ...
        loadEntityData() {
            ...
            return this.promotionRepository
                .get(this.promotionId, HeyFrame.Context.api, this.promotionCriteria)
                .then((promotion) => {
                    if (promotion === null) {
                        return;
                    }
                    ...
                    HeyFrame.Store.get('swPromotionDetail').promotion = this.promotion;
                })
                .finally(() => {
                    this.isLoading = false;
                });
        ...
        async savePromotion() {
            ...
            try {
                ...
                HeyFrame.Store.get('swPromotionDetail').setGroupIdsDelete = [];
        ...
        savePromotionSetGroups() {
            const setGroupIdsDelete = HeyFrame.Store.get('swPromotionDetail').setGroupIdsDelete;
