        ...
        }),
        {
                        ...
                        create: (entity) => {
                            if (entity === 'currency') {
                                return {
                                    search: () =>
                                        Promise.resolve(
                                            new EntityCollection('', 'currency', HeyFrame.Context.api, new Criteria(1, 25), [
                                                {
                                                    id: 'currencyId',
            ...
            props: {
                promotion: {
                    ...
                    discounts: [],
                    individualCodes: [],
                    personaRules: new EntityCollection('', 'rule', HeyFrame.Context.api, new Criteria(1, 25)),
                    personaCustomers: [],
                    orderRules: new EntityCollection('', 'rule', HeyFrame.Context.api, new Criteria(1, 25)),
                    cartRules: new EntityCollection('', 'rule', HeyFrame.Context.api, new Criteria(1, 25)),
                    translations: [],
                    hasOrders: false,
                },
                discount: {
                    ...
                    apiAlias: null,
                    id: 'discountId',
                    discountRules: new EntityCollection('', 'rule', HeyFrame.Context.api, new Criteria(1, 25)),
...
describe('src/module/sw-promotion-v2/component/sw-promotion-discount-component', () => {
    beforeAll(() => {
        HeyFrame.Service().register('syncService', () => {
            return {
                httpClient: {
                    get() {
