...
export default {
    ...
    computed: {
        promotion() {
            return HeyFrame.Store.get('swPromotionDetail').promotion;
        },

        isLoading: {
            get() {
                return HeyFrame.Store.get('swPromotionDetail').isLoading;
            },
            set(isLoading) {
                HeyFrame.Store.get('swPromotionDetail').isLoading = isLoading;
            },
        },

        discounts() {
            return (
                HeyFrame.Store.get('swPromotionDetail').promotion &&
                HeyFrame.Store.get('swPromotionDetail').promotion.discounts
            );
        },
    },
