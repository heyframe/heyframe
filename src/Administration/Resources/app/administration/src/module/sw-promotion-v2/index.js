...
HeyFrame.Component.register('sw-promotion-v2-list', () => import('./page/sw-promotion-v2-list'));
HeyFrame.Component.register('sw-promotion-v2-detail-base', () => import('./view/sw-promotion-v2-detail-base'));
HeyFrame.Component.register('sw-promotion-v2-conditions', () => import('./view/sw-promotion-v2-conditions'));
HeyFrame.Component.register('sw-promotion-detail-discounts', () => import('./view/sw-promotion-detail-discounts'));
