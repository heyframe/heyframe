...
export default HeyFrame.Mixin.register(
    ...
    defineComponent({
        ...
        created() {
            ...
            if (HeyFrame.Utils.types.isEmpty(actualQueryParameters)) {
                this.resetListing();
            } else {
        ...
        beforeRouteLeave() {
            ...
            HeyFrame.Store.get('swBulkEdit').selectedIds = [];
        },
        ...
        watch: {
            ...
            $route(newRoute, oldRoute) {
                ...
                if (HeyFrame.Utils.types.isEmpty(query)) {
                    this.resetListing();
                }
            ...
            selection() {
                HeyFrame.Store.get('heyframeApps').selectedIds = Object.keys(this.selection);
                HeyFrame.Store.get('swBulkEdit').selectedIds = Object.keys(this.selection);
            },
        ...
        methods: {
            ...
            updateRoute(
                ...
                if (HeyFrame.Utils.types.isEmpty(routeQuery)) {
