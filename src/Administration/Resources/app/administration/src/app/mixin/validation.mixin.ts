    ...
    defineComponent({
        ...
        methods: {
            ...
            validate(value: any) {
                ...
                if (HeyFrame.Utils.types.isBoolean(validation)) {
                    return validation;
                }

                if (HeyFrame.Utils.types.isString(validation)) {
                ...
                if (HeyFrame.Utils.types.isArray(validation)) {
                    valid = validation.every((validationRule) => {
                        if (HeyFrame.Utils.types.isBoolean(validationRule)) {
                            return validationRule;
                        }

                        if (HeyFrame.Utils.types.isString(validationRule)) {
