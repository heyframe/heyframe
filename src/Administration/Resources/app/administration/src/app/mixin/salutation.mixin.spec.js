...
async function createWrapper() {
    return mount(
        ...
        `,
            mixins: [
                HeyFrame.Mixin.getByName('salutation'),
            ],
            data() {
                return {
                    name: 'sw-mock-field',
...
describe('src/app/mixin/salutation.mixin.ts', () => {
    ...
    beforeEach(async () => {
        jest.spyOn(HeyFrame.Filter, 'getByName').mockImplementation(() => jest.fn(() => 'Salutation filter result'));
    ...
    it('should compute correct salutationFilter value', () => {
        ...
        expect(HeyFrame.Filter.getByName).toHaveBeenCalledWith('salutation');
    });
