...
// Mock Component
HeyFrame.Component.register('sw-mock', {
...
describe('app/mixin/generic-condition', () => {
    ...
    beforeEach(async () => {
        wrapper = shallowMount(await HeyFrame.Component.build('sw-mock'), {
            global: {
                mixins: [
                    HeyFrame.Mixin.getByName('generic-condition'),
                ],
                mocks: {
                    condition: {
        ...
        HeyFrame.Store.get('ruleConditionsConfig').config = config;
    });
