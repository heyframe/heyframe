        ...
        methods: {
            ...
            getUserSettingsEntity(identifier: string, userId: string | null = null) {
                ...
                return this.userConfigRepository
                    .search(this.userGridSettingsCriteria(identifier, userId), HeyFrame.Context.api)
                    .then((response) => {
                        if (!response.length) {
                            return null;
                        }
            ...
            async saveUserSettings(
                ...
                if (!userSettings) {
                    userSettings = this.userConfigRepository.create(HeyFrame.Context.api);
                }
                ...
                return this.userConfigRepository.save(entityData, HeyFrame.Context.api);
            },
            ...
            userGridSettingsCriteria(identifier: string, userId: string | null = null) {
                ...
                const criteria = new HeyFrame.Data.Criteria(1, 25);
                criteria.addFilter(HeyFrame.Data.Criteria.equals('key', identifier));
                criteria.addFilter(HeyFrame.Data.Criteria.equals('userId', userId));
