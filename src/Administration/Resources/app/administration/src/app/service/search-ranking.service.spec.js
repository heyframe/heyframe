...
HeyFrame.Service().register('userConfigService', () => {
    return {
...
HeyFrame.Service().register('systemConfigApiService', () => {
    return {
...
describe('app/service/search-ranking.service.js', () => {
    ...
    function addDataToRegisterUserConfigService(userConfigSearchs) {
        ...
        HeyFrame.Service('userConfigService').search = () => Promise.resolve({ data });
    }
    ...
    it('should get minSearchTermLength from config', async () => {
        const originalService = HeyFrame.Service('systemConfigApiService');
