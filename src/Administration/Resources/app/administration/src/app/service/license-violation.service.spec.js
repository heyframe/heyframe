...
const Application = HeyFrame.Application;
...
describe('app/service/license-violation.service.js', () => {
    HeyFrame.Service().register('heyframeExtensionService', () => extensionApiServiceMock);
    HeyFrame.Service().register('cacheApiService', () => cacheApiServiceMock);
