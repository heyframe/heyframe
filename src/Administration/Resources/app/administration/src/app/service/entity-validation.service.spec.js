...
describe('src/app/service/entity-validation.service.js', () => {
    beforeAll(() => {
        Object.entries(entitySchemaMock).forEach(
            ([
                ...
                HeyFrame.EntityDefinition.add(entityName, new EntityDefinition(definitionData));
            },
        );
    });

    it('should create a required heyframe error with the right error code and source pointer', () => {
    ...
    it('should validate a product and report callback errors', () => {
        ...
        expect(customValidator.mock.calls[0][2]).toBe(HeyFrame.EntityDefinition.get(testEntity.getEntityName())); // entity definition
