...
describe('src/app/init/sidebar.init', () => {
    ...
    beforeEach(() => {
        ...
        HeyFrame.Store.get('sidebar').sidebars = [];
    ...
    it('should handle uiSidebarAdd', async () => {
        ...
        expect(HeyFrame.Store.get('sidebar').sidebars).toEqual([]);
        ...
        expect(HeyFrame.Store.get('sidebar').sidebars).toHaveLength(1);
        expect(HeyFrame.Store.get('sidebar').sidebars[0]).toEqual({
            icon: 'regular-star',
            title: 'Test sidebar',
            locationId: 'test-sidebar',
            active: false,
    ...
    it('should handle uiSidebarClose', async () => {
        ...
        expect(HeyFrame.Store.get('sidebar').sidebars[0].active).toBe(false);

        // Open the sidebar
        HeyFrame.Store.get('sidebar').sidebars[0].active = true;
