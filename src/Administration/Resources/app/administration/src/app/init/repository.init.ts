...
const RepositoryFactory = HeyFrame.Classes._private.RepositoryFactory;
const { EntityHydrator, ChangesetGenerator, EntityFactory } = HeyFrame.Data;
const ErrorResolverError = HeyFrame.Data.ErrorResolver;
...
export default function initializeRepositoryFactory(container: InitContainer) {
    ...
    const factoryContainer = HeyFrame.Application.getContainer('factory');
    const serviceContainer = HeyFrame.Application.getContainer('service');
    ...
    return httpClient
        ...
        .then(({ data }) => {
            ...
            HeyFrame.Application.addServiceProvider('repositoryFactory', () => {
                return new RepositoryFactory(hydrator, changesetGenerator, entityFactory, httpClient, errorResolver);
            });
            HeyFrame.Application.addServiceProvider('entityHydrator', () => {
                return hydrator;
            });
            HeyFrame.Application.addServiceProvider('entityFactory', () => {
