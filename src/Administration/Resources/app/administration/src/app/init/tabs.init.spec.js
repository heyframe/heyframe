...
describe('src/app/init/tabs.init', () => {
    ...
    beforeAll(() => {
        ...
        // Mock component
        HeyFrame.Application.view.getComponent = () => ({});

        // Mock router factory
        HeyFrame.Application.addInitializer('router', () => {
            return new HeyFrame.Classes._private.RouterFactory(
                undefined,
                undefined,
                HeyFrame.Application.getContainer('factory').module,
            );
        });
        ...
        HeyFrame.Application.view.router = routerMock;

        // Add module to registry for receiving meta data
        HeyFrame.Module.register('sw-category', {
            type: 'core',
            name: 'category',
        ...
        HeyFrame.Module.register('sw-settings-usage-data', {
            type: 'core',
            name: 'usage-data',
    ...
    it('should initialize tab extension API correctly', async () => {
        ...
        expect(HeyFrame.Store.get('tabs').tabItems).toHaveProperty('foo-position-id');
        expect(HeyFrame.Store.get('tabs').tabItems['foo-position-id']).toEqual([
            {
                label: 'My tab item',
                componentSectionId: 'foo-component-section-id',
            },
    ...
    it('should create correct route entry for tab item when route gets opened (dynamic route)', async () => {
        ...
        // initialize view
        await HeyFrame.Application._resolveViewInitialized();
