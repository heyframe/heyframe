...
describe('src/app/init/notification.init.ts', () => {
    ...
    it('should handle notificationDispatch requests', async () => {
        ...
        const growlNotificationKey = Object.keys(HeyFrame.Store.get('notification').growlNotifications)[0];
        expect(HeyFrame.Store.get('notification').growlNotifications).toEqual({
