...
import * as cms from '@heyframe-ag/meteor-admin-sdk/es/ui/cms';
...
describe('src/app/init/cms.init.ts', () => {
    ...
    it('should handle cmsRegisterElement', async () => {
        ...
        HeyFrame.Service('cmsService').registerCmsElement = mock;
    ...
    it('should handle cmsRegisterBlock', async () => {
        ...
        HeyFrame.Service('cmsService').registerCmsBlock = mock;
