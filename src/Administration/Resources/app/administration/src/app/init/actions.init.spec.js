...
import { actionExecute } from '@heyframe-ag/meteor-admin-sdk/es/app/action';
import ExtensionSdkService from '../../core/service/api/extension-sdk.service';

describe('src/app/init/actions.init.ts', () => {
    beforeAll(() => {
        HeyFrame.Service().register('extensionSdkService', () => {
    ...
    it('should handle actionExecute', async () => {
        ...
        HeyFrame.Service('extensionSdkService').runAction = mock;
