...
describe('src/app/filter/thumbnail-size.filter.ts', () => {
    const thumbnailSizeFilter = HeyFrame.Filter.getByName('thumbnailSize');
    const mediaThumbnailFactory = HeyFrame.Service('repositoryFactory').create('media_thumbnail_size');
