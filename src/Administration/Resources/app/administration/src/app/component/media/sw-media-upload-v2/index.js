...
const { fileReader } = HeyFrame.Utils;
const { fileSize } = HeyFrame.Utils.format;
...
export default {
    ...
    data() {
        return {
            ...
            isUploadUrlFeatureEnabled: HeyFrame.Store.get('context').app.config?.settings?.enableUrlFeature ?? false,
            isLoading: false,
        };
    },
    ...
    computed: {
        ...
        mediaNameFilter() {
            return HeyFrame.Filter.getByName('mediaName');
        },
    },
