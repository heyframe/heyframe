...
export default {
    ...
    methods: {
        ...
        editItems() {
            ...
            if (this.itemCount > 0) {
                HeyFrame.Store.get('heyframeApps').selectedIds = Object.keys(this.bulkEditSelection);
                HeyFrame.Store.get('swBulkEdit').selectedIds = Object.keys(this.bulkEditSelection);
