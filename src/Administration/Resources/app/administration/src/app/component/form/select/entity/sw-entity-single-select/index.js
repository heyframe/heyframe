...
const { debounce, get } = HeyFrame.Utils;
...
export default {
    ...
    props: {
        ...
        entityCreationLabel: {
            ...
            required: false,
            default() {
                return HeyFrame.Snippet.tc('global.sw-single-select.labelEntity');
            },
        },
        ...
        createNewEntity() {
            ...
            this.repository
                ...
                .catch(() => {
                    ...
                    HeyFrame.Utils.debug.error('Only Entities with "name" as the only required field are creatable.');
                    this.isLoading = false;
                });
        },
