    ...
    methods: {
        ...
        showSearch() {
            ...
            this.propertyGroupOptionRepository
                .search(this.propertyGroupOptionCriteria, HeyFrame.Context.api)
                .then((groupOptions) => {
        ...
        loadGroups() {
            this.propertyGroupRepository.search(this.propertyGroupCriteria, HeyFrame.Context.api).then((groups) => {
                this.groups = groups;
