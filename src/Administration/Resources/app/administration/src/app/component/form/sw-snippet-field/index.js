...
export default {
    ...
    computed: {
        ...
        languageCriteria() {
            ...
            criteria.addFilter(Criteria.equals('id', HeyFrame.Context.api.systemLanguageId));
    ...
    methods: {
        async createdComponent() {
            ...
            this.snippetSets = await this.snippetSetRepository.search(new Criteria(), HeyFrame.Context.api);
        ...
        async updatePlaceholderValueToSnippetTranslation() {
            ...
            const currentLocale = HeyFrame.Store.get('session').currentLocale;
        ...
        async getSystemDefaultLocale() {
            const languages = await this.languageRepository.search(this.languageCriteria, HeyFrame.Context.api);
