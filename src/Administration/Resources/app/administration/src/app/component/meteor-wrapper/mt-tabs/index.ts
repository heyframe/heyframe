import { MtTabs } from '@heyframe-ag/meteor-component-library';
import type { TabItem } from '@heyframe-ag/meteor-component-library/dist/esm/components/navigation/mt-tabs/mt-tabs';
...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    computed: {
        tabExtensions(): TabItemEntry[] {
            return HeyFrame.Store.get('tabs').tabItems[this.positionIdentifier] ?? [];
        },
