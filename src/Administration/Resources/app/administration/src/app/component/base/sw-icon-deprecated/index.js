...
import '@heyframe-ag/meteor-icon-kit/icons/regular/tachometer.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/products.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/shopping-bag.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/users.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/content.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/megaphone.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/plug.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/cog.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/bell.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/question-circle.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/search-s.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/chevron-down-xs.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/chevron-up-xs.svg';
import '@heyframe-ag/meteor-icon-kit/icons/regular/chevron-circle-left.svg';
...
export default {
    ...
    methods: {
         ...
         *
         * Loosely based on an idea from https://heyframecommunity.slack.com/archives/C04P3QBG8S2/p1683098652206189
         *
        ...
        loadIconSvgData(variant, iconName, iconFullName) {
            ...
            return import(
                `./../../../../../node_modules/@heyframe-ag/meteor-icon-kit/icons/${variant}/${iconName}.svg?raw`
            ).then((iconSvgData) => {
