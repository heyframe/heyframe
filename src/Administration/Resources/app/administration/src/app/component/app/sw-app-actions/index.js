...
export default {
    ...
    computed: {
        ...
        params() {
            return HeyFrame.Store.get('heyframeApps').selectedIds;
        },
    ...
    methods: {
        ...
        getUserConfig() {
            this.userConfigRepository.search(this.userConfigCriteria, HeyFrame.Context.api).then((response) => {
                if (response.length) {
                    this.iframeUserConfig = response.first();
                } else {
                    this.iframeUserConfig = this.userConfigRepository.create(HeyFrame.Context.api);
        ...
        saveConfig(value) {
            ...
            this.userConfigRepository.save(this.iframeUserConfig, HeyFrame.Context.api).then(() => {
                this.getUserConfig();
            });
        },
    },
