import type { Toast } from '@heyframe-ag/meteor-component-library/dist/esm/components/feedback-indicator/mt-toast/mt-toast';
...
export default HeyFrame.Component.wrapComponentConfig({
    ...
    metaInfo() {
        return {
            title: this.$tc('global.sw-admin-menu.textHeyFrameAdmin'),
        };
    },
    ...
    created() {
        HeyFrame.ExtensionAPI.handle('toastDispatch', (toast) => {
            this.toasts = [
                {
        ...
        this.channel.onmessage = (event) => {
            ...
            if (!data || !HeyFrame.Utils.object.hasOwnProperty(data, 'inactive')) {
                return;
            }
