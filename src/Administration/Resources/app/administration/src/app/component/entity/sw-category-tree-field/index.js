...
export default {
    ...
    methods: {
        ...
        getTreeItems(parentId = null) {
            ...
            return this.globalCategoryRepository.search(criteria, HeyFrame.Context.api).then((searchResult) => {
        ...
        searchCategories(term) {
            ...
            // search for categories
            return this.globalCategoryRepository.search(categorySearchCriteria, HeyFrame.Context.api);
        },
