...
const { createId, types } = HeyFrame.Utils;
...
export default {
    ...
    methods: {
        ...
        subIsActive(path, entryId) {
            // this is an extra case for the sw-channel menu, without this all channels
            ...
            const adminMenuEntries = HeyFrame.Store.get('adminMenu').adminModuleNavigation;
            let compareTo;
