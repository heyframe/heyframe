...
const { Context, Mixin, Filter } = HeyFrame;
    ...
    methods: {
        ...
        async updateSuccessNotification(successAmount, failureAmount, totalAmount) {
            ...
            if (this.notificationId !== null) {
                await HeyFrame.Store.get('notification').updateNotification({
            ...
            const newNotificationId = await HeyFrame.Store.get('notification').createNotification({
                variant: 'success',
                ...notification,
            });
