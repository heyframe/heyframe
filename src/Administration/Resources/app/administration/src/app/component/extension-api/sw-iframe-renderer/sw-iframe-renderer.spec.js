...
import { location } from '@heyframe-ag/meteor-admin-sdk';
...
describe('src/app/component/extension-api/sw-iframe-renderer', () => {
    beforeEach(async () => {
        ...
        Object.keys(HeyFrame.Store.get('extensions').extensionsState).forEach((key) => {
            delete HeyFrame.Store.get('extensions').extensionsState[key];
        });

        // Clear sdkLocation store
        Object.keys(HeyFrame.Store.get('sdkLocation').locations).forEach((key) => {
            delete HeyFrame.Store.get('sdkLocation').locations[key];
        });
    ...
    it('should render iFrame with replacement component', async () => {
        ...
        HeyFrame.Store.get('sdkLocation').addLocation({
            locationId: 'foo',
