...
export default {
    ...
    methods: {
        createdComponent() {
            HeyFrame.Utils.EventBus.on('active-item-change', this.checkIfActive);
            HeyFrame.Utils.EventBus.on('item-select-by-keyboard', this.checkIfSelected);
        },

        destroyedComponent() {
            HeyFrame.Utils.EventBus.off('active-item-change', this.checkIfActive);
            HeyFrame.Utils.EventBus.off('item-select-by-keyboard', this.checkIfSelected);
        },
