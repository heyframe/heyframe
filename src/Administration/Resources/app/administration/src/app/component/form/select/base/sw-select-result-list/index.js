...
export default {
    ...
    methods: {
        ...
        addEventListeners() {
            ...
            HeyFrame.Utils.EventBus.on('item-select', this.onItemSelect);
        },
        ...
        removeEventListeners() {
            ...
            HeyFrame.Utils.EventBus.off('item-select', this.onItemSelect);
        },
        ...
        emitActiveItemIndex(shouldFocus = false) {
            ...
            HeyFrame.Utils.EventBus.emit('active-item-change', this.activeItemIndex, {
                shouldFocus,
            });
        },
        ...
        emitClicked() {
            ...
            HeyFrame.Utils.EventBus.emit('item-select-by-keyboard', this.activeItemIndex);
        },
