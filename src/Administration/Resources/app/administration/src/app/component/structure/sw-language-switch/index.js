...
export default {
    ...
    methods: {
        createdComponent() {
            this.languageId = HeyFrame.Context.api.languageId;
            this.lastLanguageId = this.languageId;

            HeyFrame.Utils.EventBus.on('on-change-language-clicked', this.changeToNewLanguage);
        },

        destroyedComponent() {
            HeyFrame.Utils.EventBus.off('on-change-language-clicked', this.changeToNewLanguage);
        },
        ...
        emitChange() {
            ...
            if (this.changeGlobalLanguage) {
                ...
                HeyFrame.Utils.EventBus.emit('sw-language-switch-change-application-language', {
