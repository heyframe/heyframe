...
export default {
    ...
    computed: {
        ...
        currentLocale() {
            return HeyFrame.Store.get('session').currentLocale;
        },
...
The admin menu only supports up to three levels of nesting.`,
        ...
        mainMenuEntries() {
            const tree = new HeyFrame.Helper.FlatTreeHelper((first, second) => first.position - second.position);
        ...
        extensionMenuItems() {
            return HeyFrame.Store.get('menuItem').menuItems;
        },
        ...
        adminMenuStore() {
            return HeyFrame.Store.get('adminMenu');
        },
    },
    ...
    methods: {
        ...
        getUser() {
            ...
            this.userService.getUser().then((response) => {
                ...
                HeyFrame.Store.get('session').setCurrentUser(userData);
