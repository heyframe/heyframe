...
export default {
    ...
    mixins: [
        HeyFrame.Mixin.getByName('notification'),
    ],
    ...
    computed: {
        violations() {
            return HeyFrame.Store.get('licenseViolation').violations;
        },

        warnings() {
            return HeyFrame.Store.get('licenseViolation').warnings;
        },
        ...
        pluginCriteria() {
            return new HeyFrame.Data.Criteria(1, 50);
        },
        ...
        getPluginViolation() {
            ...
            return this.licenseViolationService
                ...
                .then(({ violations, warnings, other }) => {
                    const licenseViolationStore = HeyFrame.Store.get('licenseViolation');
