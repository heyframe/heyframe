...
export default {
    ...
    computed: {
        ...
        currentAuthor() {
            return `user/${HeyFrame.Store.get('session').currentUser.username}`;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.snippetSets.forEach((snippetSet) => {
                ...
                const snippet = this.snippetRepository.create(HeyFrame.Context.api);
        ...
        onSave() {
            ...
            this.editableSnippets.forEach((snippet) => {
                ...
                if (snippet.origin !== snippet.value) {
                    ...
                    responses.push(this.snippetRepository.save(snippet, HeyFrame.Context.api));
                    ...
                    responses.push(this.snippetRepository.delete(snippet.id, HeyFrame.Context.api));
                }
            });
