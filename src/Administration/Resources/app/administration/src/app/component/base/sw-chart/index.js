...
export default {
    ...
    computed: {
        ...
        defaultLocale() {
            const adminLocaleLanguage = HeyFrame.Store.get('session').adminLocaleLanguage;
    ...
    methods: {
        ...
        getZeroValues() {
            ...
            const fromDate = HeyFrame.Utils.format.dateWithUserTimezone();
            ...
            if (this.options.xaxis.max) {
                ...
                // get actual day
                const toDate = HeyFrame.Utils.format.dateWithUserTimezone();
