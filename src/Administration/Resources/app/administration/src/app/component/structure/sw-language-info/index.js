...
export default {
    ...
    computed: {
        languageId() {
            return HeyFrame.Store.get('context').api.languageId;
        },

        systemLanguageId() {
            return HeyFrame.Store.get('context').api.systemLanguageId;
        },
    ...
    methods: {
        async refreshParentLanguage() {
            ...
            if (this.language.parentId !== null && this.language.parentId.length > 0) {
                this.parentLanguage = await this.languageRepository.get(this.language.parentId, HeyFrame.Context.api);
                return;
            }

            this.parentLanguage = await this.languageRepository.get(this.systemLanguageId, HeyFrame.Context.api);
        },
        ...
        onClickParentLanguage() {
            ...
            HeyFrame.Utils.EventBus.emit('on-change-language-clicked', this.parentLanguage.id);
        },
    },
};
