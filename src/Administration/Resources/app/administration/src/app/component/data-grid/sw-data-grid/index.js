...
export default {
    ...
    methods: {
        ...
        findUserSetting() {
            ...
            return this.userConfigRepository.search(this.userGridSettingCriteria, HeyFrame.Context.api).then((response) => {
                if (!response.length) {
                    return;
                }
        ...
        findUserSettingById() {
            return this.userConfigRepository.get(this.currentSetting.id, HeyFrame.Context.api).then((response) => {
                if (!response) {
                    return;
                }
        ...
        createUserGridSetting() {
            const newUserGrid = this.userConfigRepository.create(HeyFrame.Context.api);
        ...
        saveUserSettings() {
            ...
            this.userConfigRepository.save(this.currentSetting, HeyFrame.Context.api).then(() => {
