...
describe('src/app/component/structure/sw-desktop', () => {
    beforeAll(() => {
        HeyFrame.Store.get('context').app.config.settings = {
    ...
    it('should show the staging bar, when enabled', async () => {
        HeyFrame.Store.get('context').app.config.settings.enableStagingMode = true;
    ...
    it('should not show the staging bar, when disabled', async () => {
        HeyFrame.Store.get('context').app.config.settings.enableStagingMode = false;
