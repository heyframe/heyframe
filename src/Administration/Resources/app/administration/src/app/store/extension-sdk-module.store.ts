 ...
 * @private
 */
import type { smartBarButtonAdd } from '@heyframe-ag/meteor-admin-sdk/es/ui/main-module/';
...
const extensionSdkModules = HeyFrame.Store.register({
    ...
    actions: {
        addModule({
            ...
            const id = HeyFrame.Utils.format.md5(JSON.stringify(staticElements));
