...
export function initializeUserNotifications() {
    if (HeyFrame.Store) {
        HeyFrame.Store.get('notification').notifications = getNotificationsForUser();
    }
}
...
function _getStorageKey() {
    const user = HeyFrame.Store.get('session').currentUser;
...
const notificationStore = HeyFrame.Store.register({
    id: 'notification',
