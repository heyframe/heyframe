 ...
 * @private
 */
import { setExtensions } from '@heyframe-ag/meteor-admin-sdk/es/channel';
import type { privileges } from '@heyframe-ag/meteor-admin-sdk/es/_internals/privileges';
...
const extensions = HeyFrame.Store.register({
    id: 'extensions',
    ...
    getters: {
        privilegedExtensionBaseUrls(state) {
            const acl = HeyFrame.Service('acl');
