...
import HeyFrameError from 'src/core/data/HeyFrameError';
...
describe('error.store', () => {
    ...
    beforeEach(() => {
        ...
        store = HeyFrame.Store.get('error');
    });
    ...
    describe('actions', () => {
        describe('addApiError', () => {
            it('adds an API error', () => {
                ...
                store.addApiError({
                    ...
                    error: new HeyFrameError(base),
                });

                // @ts-expect-error
                const actual = store.api.entity.field as HeyFrameError;

                expect(actual).toBeInstanceOf(HeyFrameError);
            ...
            it('adds a nested API error', () => {
                ...
                const actual = store.api.entity.nested.field as HeyFrameError;
        ...
        describe('removeApiError', () => {
            it('removes an API error', () => {
                const error = new HeyFrameError({ code: 'TEST-003', detail: 'Test error' });
            ...
            it('removes a nested API error', () => {
                const error = new HeyFrameError({ code: 'TEST-004', detail: 'Nested error' });
        ...
        describe('resetApiErrors', () => {
            it('resets all API errors', () => {
                store.addApiError({
                    ...
                    error: new HeyFrameError({ code: 'TEST-005', detail: 'Error 1' }),
                });
                store.addApiError({
                    expression: 'entity2.field',
                    error: new HeyFrameError({ code: 'TEST-006', detail: 'Error 2' }),
                });
        ...
        describe('addSystemError', () => {
            it('adds a system error with generated ID', () => {
                const error = new HeyFrameError({ code: 'SYS-001', detail: 'System error' });
            ...
            it('adds a system error with provided ID', () => {
                const error = new HeyFrameError({ code: 'SYS-002', detail: 'System error' });
        ...
        describe('removeSystemError', () => {
            it('removes a system error', () => {
                const error = new HeyFrameError({ code: 'SYS-003', detail: 'System error' });
    ...
    describe('getters', () => {
        describe('getErrorsForEntity', () => {
            ...
            it('returns errors for a specific entity', () => {
                const error = new HeyFrameError({ code: 'ENT-001', detail: 'Entity error' });
        ...
        describe('getApiErrorFromPath', () => {
            ...
            it('returns the error at the specified path', () => {
                const error = new HeyFrameError({ code: 'PATH-001', detail: 'Nested error' });
        ...
        describe('getApiError', () => {
            it('returns the error for a given entity and field', () => {
                const error = new HeyFrameError({ code: 'FIELD-001', detail: 'Field error' });
        ...
        describe('getSystemConfigApiError', () => {
            ...
            it('returns the system config API error', () => {
                const error = new HeyFrameError({ code: 'CONFIG-001', detail: 'Config error' });
        ...
        describe('getAllApiErrors', () => {
            it('returns all API errors', () => {
                store.addApiError({
                    ...
                    error: new HeyFrameError({ code: 'ALL-001', detail: 'Error 1' }),
                });
                store.addApiError({
                    expression: 'entity2.id.field',
                    error: new HeyFrameError({ code: 'ALL-002', detail: 'Error 2' }),
                });
        ...
        describe('existsErrorInProperty', () => {
            ...
            it('returns true if an error exists in the specified property', () => {
                store.addApiError({
                    ...
                    error: new HeyFrameError({ code: 'PROP-001', detail: 'Error' }),
                });
        ...
        describe('getSystemError', () => {
            ...
            it('returns the system error with the given ID', () => {
                const error = new HeyFrameError({ code: 'SYS-004', detail: 'System error' });
                store.addSystemError({ error, id: 'test-id' });
        ...
        describe('countSystemError', () => {
            it('returns the correct count of system errors', () => {
                ...
                store.addSystemError({ error: new HeyFrameError({ code: 'COUNT-001', detail: 'Error 1' }) });
                store.addSystemError({ error: new HeyFrameError({ code: 'COUNT-002', detail: 'Error 2' }) });
