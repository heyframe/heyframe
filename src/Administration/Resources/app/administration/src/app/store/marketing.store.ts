...
const marketingStore = HeyFrame.Store.register({
    id: 'marketing',
        ...
        setCampaign(campaign: Campaign) {
            ...
            Object.entries(translations).forEach(
                ([
                    ...
                    HeyFrame.Snippet.mergeLocaleMessage(langIsoCode, snippets);
                },
            );
        },
    ...
    getters: {
        getActiveCampaign(): null | Campaign {
            ...
            if (
                HeyFrame.Service('heyframeDiscountCampaignService')?.isDiscountCampaignActive(
