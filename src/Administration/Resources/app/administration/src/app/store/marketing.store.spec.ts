...
describe('marketing.store', () => {
    let store = HeyFrame.Store.get('marketing');
    ...
    beforeEach(() => {
        store = HeyFrame.Store.get('marketing');
        store.campaign = {};
    ...
    it('should set a new campaign', () => {
        HeyFrame.Store.get('marketing').setCampaign({
            name: 'Example campaign',
            components: {},
        });

        expect(HeyFrame.Store.get('marketing').campaign).toEqual({
            name: 'Example campaign',
            components: {},
        });
    });
    ...
    it('should return the active campaign when times match', () => {
        ...
        const activeCampaign = HeyFrame.Store.get('marketing').getActiveCampaign;
    ...
    it('should return the correct component for the store banner when time match', () => {
        ...
        const storeComponent = HeyFrame.Store.get('marketing').getActiveCampaignDataForComponent('storeBanner');
