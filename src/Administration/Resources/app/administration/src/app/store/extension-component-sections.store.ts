 ...
 */
import type { uiComponentSectionRenderer } from '@heyframe-ag/meteor-admin-sdk/es/ui/component-section';
...
const ExtensionComponentSectionsStore = HeyFrame.Store.register({
