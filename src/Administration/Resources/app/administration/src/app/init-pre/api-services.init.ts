...
export default async function initializeApiServices() {
    ...
    for (const ApiServicePromise of HeyFrame._private.ApiServices()) {
        ...
        const service = new ApiService(initContainer.httpClient, HeyFrame.Service('loginService'));
        ...
        HeyFrame.Application.addServiceProvider(serviceName, () => {
