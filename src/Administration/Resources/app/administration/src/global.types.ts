...
import '@heyframe-ag/meteor-admin-sdk';
...
import type { HeyFrameApps } from './app/store/heyframe-apps.store';
...
import type { HeyFrameExtensionsStore } from './module/sw-extension/store/extensions.store';
...
declare global {
    ...
    interface CustomHeyFrameProperties {}

    interface CustomHeyFrameConstants {
    ...
    /**
     * Make the HeyFrame object globally available
     */
    const HeyFrame: HeyFrameClass & CustomHeyFrameProperties;
    ...
    interface Window {
        HeyFrame: HeyFrameClass & CustomHeyFrameProperties;
        _features_: {
    ...
    interface PiniaRootState {
        ...
        heyframeExtensions: HeyFrameExtensionsStore;
    ...
    /**
     * @see HeyFrame\Core\Framework\Api\EventListener\ErrorResponseFactory
     */
    interface HeyFrameHttpError {
        code: string;
        status: string;
        title: string;
        detail: string;
        meta?: {
            ...
            parameters?: object;
            previous?: HeyFrameHttpError;
        };
        trace?: { [key: string]: string };
    }

    interface HeyFrameErrorMeta {
        parameters: {
            dependency: string;
    ...
    interface HeyFrameError {
        code: string;
        meta: HeyFrameErrorMeta;
    }

    interface HeyFrameApiError {
        response: {
            data: {
                errors: HeyFrameError[];
            };
        };
    }

    interface StoreApiException extends HeyFrameHttpError {
        meta?: HeyFrameHttpError['meta'] & {
...
declare module 'axios' {
    interface AxiosRequestConfig {
        // adds the heyframe API version to the RequestConfig
        version?: number;
    }
}
