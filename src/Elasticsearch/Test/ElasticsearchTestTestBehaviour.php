...
use HeyFrame\Core\Framework\DataAbstractionLayer\Dbal\EntitySearcher;
use HeyFrame\Core\Framework\Log\Package;
use HeyFrame\Elasticsearch\Framework\Command\ElasticsearchIndexingCommand;
use HeyFrame\Elasticsearch\Framework\DataAbstractionLayer\AbstractElasticsearchAggregationHydrator;
use HeyFrame\Elasticsearch\Framework\DataAbstractionLayer\AbstractElasticsearchSearchHydrator;
use HeyFrame\Elasticsearch\Framework\DataAbstractionLayer\CriteriaParser;
use HeyFrame\Elasticsearch\Framework\DataAbstractionLayer\ElasticsearchEntityAggregator;
...
trait ElasticsearchTestTestBehaviour
{
    ...
    protected function clearElasticsearch(): void
    {
        ...
        $indices = $client->indices()->get(['index' => EnvironmentHelper::getVariable('HEYFRAME_ES_INDEX_PREFIX') . '*']);
