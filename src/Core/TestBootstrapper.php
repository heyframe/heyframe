...
class TestBootstrapper
{
    ...
    public function addCallingPlugin(?string $pathToComposerJson = null): TestBootstrapper
    {
        ...
        $baseClass = $composer['extra']['heyframe-plugin-class'] ?? '';
        if ($baseClass === '') {
            throw new \RuntimeException('composer.json does not contain `extra.heyframe-plugin-class`. Path: ' . $pathToComposerJson);
        }
