    ...
    public function update(Connection $connection): void
    {
        $sql = <<<'SQL'
            CREATE TABLE `channel` (
              ...
              KEY `fk.channel.navigation_id` (`navigation_id`,`navigation_version_id`),
              ...
              CONSTRAINT `fk.channel.navigation_id` FOREIGN KEY (`navigation_id`, `navigation_version_id`) REFERENCES `navigation` (`id`, `version_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
