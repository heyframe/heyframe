...
SQL;
        ...
        $sql = <<<'SQL'
            CREATE TABLE `number_range_channel` (
              ...
              `updated_at` DATETIME(3) NULL,
              PRIMARY KEY (`id`),
              UNIQUE `uniq.numer_range_id__channel_id` (`number_range_id`, `channel_id`),
              CONSTRAINT `fk.number_range_channel.number_range_id`
                FOREIGN KEY (number_range_id) REFERENCES `number_range` (id) ON DELETE CASCADE ON UPDATE CASCADE,
              CONSTRAINT `fk.number_range_channel.channel_id`
                FOREIGN KEY (channel_id) REFERENCES `channel` (id) ON DELETE CASCADE ON UPDATE CASCADE,
              CONSTRAINT `fk.number_range_channel.number_range_type_id`
