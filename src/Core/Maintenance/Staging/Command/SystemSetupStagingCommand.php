...
#[AsCommand(
    ...
    description: 'Installs the HeyFrame 6 system in staging mode',
)]
#[Package('framework')]
class SystemSetupStagingCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!$input->getOption('force') && !$io->confirm('This command will install the HeyFrame 6 system in staging mode. It will overwrite existing data in this database, make sure you use a staging database and have a backup', false)) {
            return self::FAILURE;
        }
