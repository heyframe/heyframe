...
class ScriptPriceStubs implements ResetInterface
{
    ...
    public function calculateQuantity(QuantityPriceDefinition $definition, ChannelContext $context): CalculatedPrice
    {
        return $this->quantityCalculator->calculate($definition, $context);
    }

    public function calculatePercentage(float $percentage, CalculatedPriceCollection $prices, ChannelContext $context): CalculatedPrice
    {
