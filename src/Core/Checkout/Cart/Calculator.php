...
class Calculator
{
    ...
    public function calculate(LineItemCollection $lineItems, ChannelContext $context, CartBehavior $behavior): LineItemCollection
    {
        return $this->calculateLineItems($lineItems, $context, $behavior);
    }

    private function calculateLineItems(LineItemCollection $lineItems, ChannelContext $context, CartBehavior $behavior): LineItemCollection
    {
    ...
    private function filterLineItems(LineItemCollection $calculated, ?Rule $filter, ChannelContext $context): LineItemCollection
    {
        if (!$filter) {
            return $calculated;
        }
    ...
    private function calculatePrice(LineItem $lineItem, ChannelContext $context, LineItemCollection $calculated, CartBehavior $behavior): CalculatedPrice
    {
