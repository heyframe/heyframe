...
class LineItemFactoryRegistry
{
     ...
     * @param array<string|int, mixed> $data
     */
    public function update(Cart $cart, array $data, ChannelContext $context): void
    {
        $identifier = $data['id'];
     ...
     * @param array<string|int, mixed> $data
     */
    public function updateLineItem(Cart $cart, array $data, LineItem $lineItem, ChannelContext $context): void
    {
        if (!isset($data['type'])) {
