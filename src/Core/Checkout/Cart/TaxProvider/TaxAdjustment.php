...
class TaxAdjustment
{
    ...
    public function adjust(Cart $cart, TaxProviderResult $result, ChannelContext $context): void
    {
    ...
    private function applyCartPriceTaxes(CartPrice $price, CalculatedTaxCollection $taxes, ChannelContext $context): CartPrice
    {
