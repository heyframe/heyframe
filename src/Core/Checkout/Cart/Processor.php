...
class Processor
{
    ...
    public function process(Cart $original, ChannelContext $context, CartBehavior $behavior): Cart
    {
    ...
    private function runProcessors(Cart $original, Cart $cart, ChannelContext $context, CartBehavior $behavior): void
    {
    ...
    private function calculateAmount(ChannelContext $context, Cart $cart): void
    {
