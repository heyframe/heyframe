...
class LineItemGroupBuilder
{
     ...
     */
    public function findGroupPackages(array $groupDefinitions, Cart $cart, ChannelContext $context): LineItemGroupBuilderResult
    {
     ...
     */
    private function splitQuantities(LineItemCollection $cartItems, ChannelContext $context): LineItemFlatCollection
    {
        $items = [];
