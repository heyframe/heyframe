...
use HeyFrame\Core\Checkout\Customer\Event\PasswordRecoveryUrlEvent;
...
class SendPasswordRecoveryMailRoute extends AbstractSendPasswordRecoveryMailRoute
{
    ...
    public function sendRecoveryMail(RequestDataBag $data, ChannelContext $context, bool $validateStorefrontUrl = true): SuccessResponse
    {
    ...
    private function validateRecoverEmail(DataBag $data, ChannelContext $context, bool $validateStorefrontUrl = true): void
    {
    ...
    private function getCustomerByEmail(string $email, ChannelContext $context): CustomerEntity
    {
        $criteria = (new Criteria())
            ...
            ->addFilter(new MultiFilter(MultiFilter::CONNECTION_OR, [
                ...
                new EqualsFilter('customer.boundChannelId', $context->getChannelId()),
            ]));
