...
use HeyFrame\Core\Checkout\Customer\Rule\CustomerNumberRule;
...
class PromotionEntity extends Entity
{
    ...
    protected ?PromotionChannelCollection $channels = null;
     ...
     */
    public function getChannels(): ?PromotionChannelCollection
    {
     ...
     */
    public function setChannels(PromotionChannelCollection $channels): void
    {
    ...
    public function getPreconditionRule(): Rule
    {
        ...
        if ($this->isUseSetGroups() && $this->getSetgroups() !== null && $this->getSetgroups()->count() > 0) {
            ...
            // must match now to fulfill the new group definition in heyframe promotions
