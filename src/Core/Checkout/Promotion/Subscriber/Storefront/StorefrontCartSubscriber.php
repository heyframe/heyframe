...
class StorefrontCartSubscriber implements EventSubscriberInterface
{
    ...
    public function onLineItemRemoved(BeforeLineItemRemovedEvent $event): void
    {
        ...
        if (!empty($code)) {
            ...
            $this->removeOtherDiscountsOfPromotion($cart, $lineItem, $event->getChannelContext());
    ...
    private function removeOtherDiscountsOfPromotion(Cart $cart, LineItem $removedLineItem, ChannelContext $context): void
    {
