...
class PromotionDeliveryCalculator
{
     ...
     */
    public function calculate(LineItemCollection $discountLineItems, Cart $original, Cart $toCalculate, ChannelContext $context): void
    {
     ...
     */
    private function buildExclusions(LineItemCollection $discountLineItems, Cart $toCalculate, ChannelContext $context): array
    {
     ...
     */
    private function calculateDeliveryPromotion(Cart $toCalculate, LineItem $discountLineItem, ChannelContext $context, float $notDiscountedShippingCosts): bool
    {
     ...
     */
    private function calculateAbsolute(DeliveryCollection $deliveries, AbsolutePriceDefinition $definition, ChannelContext $context): bool
    {
        $deliveryAdded = false;
        // get discount value
     ...
     */
    private function calculatePercentage(DeliveryCollection $deliveries, PercentagePriceDefinition $definition, ChannelContext $context, string $maxValue): bool
    {
        $deliveryAdded = false;
     ...
     */
    private function calculateFixedDiscount(DeliveryCollection $deliveries, AbsolutePriceDefinition $definition, ChannelContext $context, float $notDiscountedShippingCosts): bool
    {
        $deliveryAdded = false;
     ...
     * @throws CartException
     */
    private function addFakeLineitem(Cart $toCalculate, LineItem $discount, ChannelContext $context): void
    {
