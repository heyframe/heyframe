...
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Calculator\DiscountAbsoluteCalculator;
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Calculator\DiscountFixedPriceCalculator;
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Calculator\DiscountFixedUnitPriceCalculator;
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Calculator\DiscountPercentageCalculator;
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Composition\DiscountCompositionBuilder;
...
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Filter\AdvancedPackagePicker;
use HeyFrame\Core\Checkout\Promotion\Cart\Discount\Filter\PackageFilter;
...
class PromotionCalculator
{
     ...
     */
    private function buildExclusions(LineItemCollection $discountLineItems, Cart $calculated, ChannelContext $context): array
    {
        // array that holds all excluded promotion ids.
        // if a promotion has exclusions they are added on the stack
        $exclusions = [];
     ...
     */
    private function limitDiscountResult(float $maxDiscountValue, PriceCollection $priceCollection, DiscountCalculatorResult $originalResult, ChannelContext $context): DiscountCalculatorResult
    {
     ...
     */
    private function isRequirementValid(LineItem $lineItem, Cart $calculated, ChannelContext $context): bool
    {
     ...
     */
    private function calculateCart(Cart $cart, ChannelContext $context): void
    {
