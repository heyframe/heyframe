...
abstract class AbstractPaymentHandler
{
     ...
     *
     * The refund process of HeyFrame is only provided via API and has no frontend methods.
     */
     ...
     * This is used e.g. by HeyFrame's commercial feature "Subscriptions", but is open to be supported by other implementations as well.
     */
