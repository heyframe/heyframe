...
use HeyFrame\Core\Framework\DataAbstractionLayer\Field\Flag\Extension as DalExtension;
    ...
    private static function defineField(array $field, FieldCollection $collection, string $entityName, ContainerInterface $container): void
    {
        ...
        switch ($field['type']) {
            ...
            case 'many-to-many':
                ...
                // field is maybe flag to be front-api aware
            ...
            case 'many-to-one':
                ...
                // add flag for front-api awareness
                self::addFlag($association, $apiAware);
