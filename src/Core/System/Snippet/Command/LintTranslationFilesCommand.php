...
namespace HeyFrame\Core\System\Snippet\Command;
...
use HeyFrame\Core\System\Snippet\Struct\LintedTranslationFileOptions;
use HeyFrame\Core\System\Snippet\Struct\LintedTranslationFileStruct;
...
#[AsCommand(
    ...
    For more information, see our documentation: https://developer.heyframe.net/docs/concepts/translations/fallback-language-selection.html#migration-and-linting-via-command',
)]
#[Package('discovery')]
class LintTranslationFilesCommand extends Command
{
    ...
    private function renderOutput(
        ...
        https://developer.heyframe.net/docs/concepts/translations/fallback-language-selection.html
        CLI);
