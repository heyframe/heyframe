...
**LayoutResolver::resolve(RouteMatchResult, ResolvedData, ChannelContext): ?string**
...
**LayoutResolver::matchesAssociation(ContentLayoutAssignmentEntity, ResolvedData, ChannelContext): bool**
...
- When priorities equal, channel-specific ranked higher than global (ORDER BY channel_id DESC)
- Assignment visible if: `channel_id = context OR channel_id IS NULL`
