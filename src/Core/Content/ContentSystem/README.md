...
Store API entry point (`/store-api/content/{path}`) orchestrates full pipeline in Channel/.
...
- `ContentRoute` - Store API endpoint, orchestrates pipeline (Channel/)
