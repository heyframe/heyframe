...
use HeyFrame\Core\Content\ImportExport\Exception\FileNotFoundException;
use HeyFrame\Core\Content\ImportExport\Exception\InvalidFileAccessTokenException;
use HeyFrame\Core\Content\ImportExport\Exception\InvalidIdentifierException;
...
class ImportExportException extends HttpException
{
    ...
    public static function invalidFileAccessToken(): HeyFrameHttpException
    {
        return new InvalidFileAccessTokenException();
    }

    public static function fileNotFound(string $fileId): HeyFrameHttpException
    {
        return new FileNotFoundException($fileId);
    }

    public static function processingError(string $message): HeyFrameHttpException
    {
        return new ProcessingException($message);
    }

    public static function requiredByUser(string $column): HeyFrameHttpException
    {
        return new RequiredByUserException($column);
    }

    public static function invalidIdentifier(string $id): HeyFrameHttpException
    {
        return new InvalidIdentifierException($id);
    }

    public static function decorationPattern(string $class): HeyFrameHttpException
    {
        return new DecorationPatternException($class);
    }

    public static function profileNotFound(string $profileId): HeyFrameHttpException
    {
