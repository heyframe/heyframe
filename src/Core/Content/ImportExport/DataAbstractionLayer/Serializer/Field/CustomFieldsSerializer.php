...
use HeyFrame\Core\Framework\DataAbstractionLayer\FieldSerializer\CustomFieldsSerializer as DalCustomFieldsSerializer;
...
class CustomFieldsSerializer extends FieldSerializer
{
    ...
    public function deserialize(Config $config, Field $field, $value): mixed
    {
        ...
        if (isset($value[0]) && \is_string($value[0])) {
            /** @var array|null $customFieldsFromJson */
