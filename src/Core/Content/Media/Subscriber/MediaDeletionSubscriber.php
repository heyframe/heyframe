...
use HeyFrame\Core\Content\Media\Event\MediaThumbnailDeletedEvent;
use HeyFrame\Core\Content\Media\MediaCollection;
use HeyFrame\Core\Content\Media\MediaDefinition;
use HeyFrame\Core\Content\Media\Message\DeleteFileHandler;
use HeyFrame\Core\Content\Media\Message\DeleteFileMessage;
