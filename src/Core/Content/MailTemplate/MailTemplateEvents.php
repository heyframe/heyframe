...
class MailTemplateEvents
{
    ...
    final public const MAIL_TEMPLATE_CHANNEL_WRITTEN_EVENT = 'mail_template_channel.written';

    final public const MAIL_TEMPLATE_CHANNEL_DELETED_EVENT = 'mail_template_channel.deleted';

    final public const MAIL_TEMPLATE_CHANNEL_LOADED_EVENT = 'mail_template_channel.loaded';

    final public const MAIL_TEMPLATE_CHANNEL_SEARCH_RESULT_LOADED_EVENT = 'mail_template_channel.search.result.loaded';

    final public const MAIL_TEMPLATE_CHANNEL_AGGREGATION_LOADED_EVENT = 'mail_template_channel.aggregation.result.loaded';

    final public const MAIL_TEMPLATE_CHANNEL_ID_SEARCH_RESULT_LOADED_EVENT = 'mail_template_channel.id.search.result.loaded';
    ...
    final public const MAIL_HEADER_FOOTER_CHANNEL_WRITTEN_EVENT = 'mail_header_footer_channel.written';

    final public const MAIL_HEADER_FOOTER_CHANNEL_DELETED_EVENT = 'mail_header_footer_channel.deleted';

    final public const MAIL_HEADER_FOOTER_CHANNEL_LOADED_EVENT = 'mail_header_footer_channel.loaded';

    final public const MAIL_HEADER_FOOTER_CHANNEL_SEARCH_RESULT_LOADED_EVENT = 'mail_header_footer_channel.search.result.loaded';

    final public const MAIL_HEADER_FOOTER_CHANNEL_AGGREGATION_LOADED_EVENT = 'mail_header_footer_channel.aggregation.result.loaded';

    final public const MAIL_HEADER_FOOTER_CHANNEL_ID_SEARCH_RESULT_LOADED_EVENT = 'mail_header_footer_channel.id.search.result.loaded';
}
