...
class ProductConfiguratorLoader
{
     ...
     */
    private function loadSettings(string $parentId, ChannelContext $context): ?array
    {
     ...
     */
    private function sortSettings(?array $groups, ChannelProductEntity $product): PropertyGroupCollection
    {
        if (!$groups) {
            return new PropertyGroupCollection();
        }
     ...
     */
    private function buildCurrentOptions(ChannelProductEntity $product, PropertyGroupCollection $groups): array
    {
