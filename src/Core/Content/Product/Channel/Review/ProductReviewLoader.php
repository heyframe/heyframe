...
use HeyFrame\Core\Content\Product\Aggregate\ProductReview\ProductReviewEntity;
use HeyFrame\Core\Content\Product\Channel\Review\Event\ProductReviewsLoadedEvent;
...
class ProductReviewLoader extends AbstractProductReviewLoader
{
    ...
    private function createReviewCriteria(Request $request, ChannelContext $context): Criteria
    {
        $limit = $this->systemConfigService->getInt('core.listing.reviewsPerPage', $context->getChannelId());
    ...
    private function getCustomerReview(string $productId, ChannelContext $context): ?ProductReviewEntity
    {
    ...
    private function handlePointsAggregation(Request $request, Criteria $criteria, ChannelContext $context): void
    {
        $reviewFilters = [];
