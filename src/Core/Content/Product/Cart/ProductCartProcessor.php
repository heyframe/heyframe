...
class ProductCartProcessor implements CartProcessorInterface, CartDataCollectorInterface
{
    ...
    private function getPriceDefinition(ChannelProductEntity $product, int $quantity): QuantityPriceDefinition
    {
     ...
     */
    private function recalculate(array $lineItems, CartDataCollection $data, ChannelContext $context, CartBehavior $behavior): void
    {
        $affected = [];
    ...
    private function getDataContextHash(ChannelContext $context): string
    {
