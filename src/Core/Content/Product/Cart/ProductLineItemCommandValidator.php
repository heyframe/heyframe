...
use HeyFrame\Core\Content\Product\Exception\ProductLineItemDifferentIdException;
use HeyFrame\Core\Content\Product\Exception\ProductLineItemInconsistentException;
