...
use HeyFrame\Core\Content\Product\Events\ProductNoLongerAvailableEvent;
use HeyFrame\Core\Content\Product\Events\ProductStockAlteredEvent;
...
class StockStorage extends AbstractStockStorage
{
    ...
    public function load(StockLoadRequest $stockRequest, ChannelContext $context): StockDataCollection
    {
