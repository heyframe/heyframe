...
/**
 * The `ProductProxy` is a wrapper for the `ChannelProductEntity`. It provides access to all properties of the product,
...
class ProductProxy implements \ArrayAccess
{
    ...
    /**
     * The `__get()` function allows access to all properties of the [ChannelProductEntity](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Content/Product/Channel/ChannelProductEntity.php)
     *
