...
namespace HeyFrame\Core\Content\Test\Product;

use HeyFrame\Core\Content\Product\Aggregate\ProductVisibility\ProductVisibilityDefinition;
use HeyFrame\Core\Content\Test\Cms\LayoutBuilder;
use HeyFrame\Core\Content\Test\TestProductSeoUrlRoute;
 ...
 * @phpstan-type Visibilities array<string, array{channelId: string, visibility: int}>
 * @phpstan-type ProductReviews array<array{title: string, content: string, points: float, languageId: string, channelId: string, status: bool, customerId: string|null}>
...
class ProductBuilder
{
    ...
    /**
     * @var array<array{channelId: string, languageId: string, routeName: TestProductSeoUrlRoute::ROUTE_NAME, pathInfo: string, seoPathInfo: string}>
     */
    ...
    public function visibility(string $channelId = TestDefaults::CHANNEL, int $visibility = ProductVisibilityDefinition::VISIBILITY_ALL): self
    {
