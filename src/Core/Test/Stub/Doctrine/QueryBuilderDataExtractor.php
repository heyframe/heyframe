...
namespace HeyFrame\Core\Test\Stub\Doctrine;
 ...
 *
 * It should be removed as soon as no tests are using it anymore (see https://github.com/heyframe/heyframe/issues/7760).
 *
 * @internal
 */
#[Package('framework')]
