...
use HeyFrame\Core\Framework\App\Event\Hooks\AppDeletedHook;
use HeyFrame\Core\Framework\App\Event\Hooks\AppInstalledHook;
use HeyFrame\Core\Framework\App\Event\Hooks\AppUpdatedHook;
use HeyFrame\Core\Framework\App\Event\PostAppDeletedEvent;
use HeyFrame\Core\Framework\App\Exception\AppRegistrationException;
use HeyFrame\Core\Framework\App\Flow\Action\Action;
use HeyFrame\Core\Framework\App\Flow\Event\Event;
...
use HeyFrame\Core\Framework\App\Lifecycle\Persister\PaymentMethodPersister;
...
use HeyFrame\Core\Framework\App\Manifest\Xml\Administration\Module;
use HeyFrame\Core\Framework\App\Manifest\Xml\Webhook\Webhook;
use HeyFrame\Core\Framework\App\Source\SourceResolver;
use HeyFrame\Core\Framework\App\Validation\ConfigValidator;
...
use HeyFrame\Core\System\CustomEntity\CustomEntityCollection;
use HeyFrame\Core\System\CustomEntity\CustomEntityLifecycleService;
use HeyFrame\Core\System\CustomEntity\Schema\CustomEntitySchemaUpdater;
use HeyFrame\Core\System\CustomEntity\Xml\Field\AssociationField;
...
class AppLifecycle extends AbstractAppLifecycle
{
    ...
    public function ensureIsCompatible(Manifest $manifest): void
    {
        ...
        if (!$manifest->getMetadata()->getCompatibility()->matches($versionParser->parseConstraints($this->heyframeVersion))) {
