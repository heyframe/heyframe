...
use HeyFrame\Core\Framework\App\Manifest\Xml\CustomField\CustomFieldSet;
    ...
    private function upsertCustomFieldSets(?CustomFields $customFields, string $appId, Context $context): void
    {
        ...
        foreach ($groupedByName as $name => $ids) {
            if (\count($ids) > 1) {
                ...
                // as we can not map the fields to the correct set anymore, see https://github.com/heyframe/heyframe/issues/10738
