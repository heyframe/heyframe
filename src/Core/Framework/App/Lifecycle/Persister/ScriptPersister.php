...
use HeyFrame\Core\Framework\Script\ScriptCollection;
...
class ScriptPersister
{
    ...
    public function refresh(): void
    {
        ...
        // We don't automatically update service scripts, as that would do a request to the service on every request to heyframe
