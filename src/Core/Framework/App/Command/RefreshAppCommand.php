...
use HeyFrame\Core\Framework\App\Validation\ManifestValidator;
...
class RefreshAppCommand extends Command
{
    ...
    private function validateRefreshableApps(RefreshableAppDryRun $refreshableApps, HeyFrameStyle $io, Context $context): int
    {
    ...
    private function grantPermissions(RefreshableAppDryRun $refreshableApps, HeyFrameStyle $io): void
    {
        $default = true;
    ...
    private function grantPermissionsForApp(Manifest $app, HeyFrameStyle $io, bool $install = true): void
    {
