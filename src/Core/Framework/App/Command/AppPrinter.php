...
class AppPrinter
{
    ...
    public function printInstalledApps(HeyFrameStyle $io, Context $context): void
    {
     ...
     */
    public function printIncompleteInstallations(HeyFrameStyle $io, array $fails): void
    {
        if (empty($fails)) {
            return;
        }
    ...
    public function printPermissions(Manifest $manifest, HeyFrameStyle $io, bool $install): void
    {
     ...
     */
    public function checkHosts(Manifest $manifest, HeyFrameStyle $io): void
    {
     ...
     */
    private function printHosts(Manifest $app, array $hosts, HeyFrameStyle $io, bool $install): void
    {
        $io->caution(
            \sprintf(
    ...
    private function printPermissionTable(HeyFrameStyle $io, Permissions $permissions): void
    {
        $permissionTable = [];
