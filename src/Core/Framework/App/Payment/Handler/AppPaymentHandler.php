...
namespace HeyFrame\Core\Framework\App\Payment\Handler;
...
use HeyFrame\Core\Checkout\Order\Aggregate\OrderTransactionCaptureRefund\OrderTransactionCaptureRefundEntity;
...
use HeyFrame\Core\Checkout\Payment\Cart\RefundPaymentTransactionStruct;
...
use HeyFrame\Core\Framework\App\Payment\Payload\PaymentPayloadService;
use HeyFrame\Core\Framework\App\Payment\Payload\Struct\PaymentPayload;
use HeyFrame\Core\Framework\App\Payment\Payload\Struct\RefundPayload;
use HeyFrame\Core\Framework\App\Payment\Payload\Struct\ValidatePayload;
use HeyFrame\Core\Framework\App\Payment\Response\AbstractResponse;
use HeyFrame\Core\Framework\App\Payment\Response\PaymentResponse;
use HeyFrame\Core\Framework\App\Payment\Response\RefundResponse;
use HeyFrame\Core\Framework\App\Payment\Response\ValidateResponse;
...
class AppPaymentHandler extends AbstractPaymentHandler
{
    ...
    public function validate(Cart $cart, RequestDataBag $dataBag, ChannelContext $context): Struct
    {
    ...
    private function buildValidatePayload(Cart $cart, RequestDataBag $dataBag, ChannelContext $context): ValidatePayload
    {
