 ...
 * @internal
 *
 * @codeCoverageIgnore - Covered by @see \HeyFrame\Tests\Integration\Core\Framework\Adapter\Twig\ReturnNodeTest
 */
#[Package('framework')]
#[YieldReady]
class MacroOverrideNode extends MacroNode
{
    public function compile(Compiler $compiler): void
    {
        ...
        $compiler
            ...
            ->write("if (\HeyFrame\Core\Framework\Adapter\Twig\SwTwigFunction::\$macroResult !== null) {\n")
            ->write('$result = \HeyFrame\Core\Framework\Adapter\Twig\SwTwigFunction::$macroResult;' . "\n")
            ->write('\HeyFrame\Core\Framework\Adapter\Twig\SwTwigFunction::$macroResult = null;' . "\n")
            ->write("}\n")
            ->write("return \$result;\n")
