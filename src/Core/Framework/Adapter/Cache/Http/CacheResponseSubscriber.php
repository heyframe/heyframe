...
use HeyFrame\Core\Framework\Adapter\Cache\CacheStateSubscriber;
use HeyFrame\Core\Framework\Adapter\Cache\Event\HttpCacheCookieEvent;
...
class CacheResponseSubscriber implements EventSubscriberInterface
{
    ...
    public function onCustomerLogin(CustomerLoginEvent $event): void
    {
        ...
        $request->attributes->set(PlatformRequest::ATTRIBUTE_CHANNEL_CONTEXT_OBJECT, $event->getChannelContext());
    }
    ...
    public function onCustomerLogout(CustomerLogoutEvent $event): void
    {
        ...
        $context = clone $event->getChannelContext();
     ...
     * @return list<string>
     */
    private function updateSystemState(Cart $cart, ChannelContext $context, Request $request, Response $response): array
    {
     ...
     * @return list<string>
     */
    private function getSystemStates(Request $request, ChannelContext $context, Cart $cart): array
    {
        $states = [];
    ...
    {
        $currencyId = $request->get(ChannelContextService::CURRENCY_ID);
