...
use HeyFrame\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
use HeyFrame\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtectionValidator;
...
class ApiController extends AbstractController
{
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \HeyFrame\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \HeyFrame\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
             ...
             * $definition:     \HeyFrame\Core\Checkout\Order\Aggregate\OrderCustomer\OrderCustomerDefinition
             */
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \HeyFrame\Core\Content\Category\CategoryDefinition
             */
