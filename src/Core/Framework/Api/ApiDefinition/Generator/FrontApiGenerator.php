...
class FrontApiGenerator implements ApiDefinitionGeneratorInterface
{
    ...
    {
        $openApi->info->description = 'This endpoint reference contains an overview of all endpoints comprising the HeyFrame Store API';
        $openApi->info->license = new License([
            'name' => 'MIT',
            'url' => 'https://github.com/heyframe/heyframe/blob/trunk/LICENSE',
        ]);
    }
     ...
     * As in HeyFrame has a number of GET routes that support passing criteria as a set of parameters,
