...
namespace HeyFrame\Core\Framework\Api;
...
class ApiException extends HttpException
{
    ...
    public const API_UNSUPPORTED_FRONT_API_SCHEMA_ENDPOINT = 'FRAMEWORK__UNSUPPORTED_FRONT_API_SCHEMA_ENDPOINT';
    ...
    public const API_CHANNEL_ID_PARAMETER_IS_MISSING = 'FRAMEWORK__API_CHANNEL_ID_PARAMETER_IS_MISSING';
    ...
    public const API_CHANNEL_MAINTENANCE_MODE = 'FRAMEWORK__API_CHANNEL_MAINTENANCE_MODE';
     ...
     */
    public static function missingPrivileges(array $permissions): HeyFrameHttpException
    {
        return new MissingPrivilegeException($permissions);
    }

    public static function missingReverseAssociation(string $entity, string $parentEntity): HeyFrameHttpException
    {
    ...
    public static function noEntityCloned(string $entity, string $id): HeyFrameHttpException
    {
     ...
     * @param string[] $fails
     */
    public static function expectationFailed(array $fails): HeyFrameHttpException
    {
        return new ExpectationFailedException($fails);
    }

    public static function invalidSyncOperation(string $message): HeyFrameHttpException
    {
    ...
    public static function invalidVersionName(): HeyFrameHttpException
    {
        return new InvalidVersionNameException();
    }

    public static function channelNotFound(): HeyFrameHttpException
    {
        return new ChannelNotFoundException();
    }

    public static function deleteLiveVersion(): HeyFrameHttpException
    {
     ...
     */
    public static function resourceNotFound(string $entity, array $payload): HeyFrameHttpException
    {
    ...
    public static function unsupportedFrontApiSchemaEndpoint(): self
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
            self::API_UNSUPPORTED_FRONT_API_SCHEMA_ENDPOINT,
    ...
    public static function channelIdParameterIsMissing(): self
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
            self::API_CHANNEL_ID_PARAMETER_IS_MISSING,
    ...
    public static function channelInMaintenanceMode(): self
    {
        return new self(
            ...
            self::API_CHANNEL_MAINTENANCE_MODE,
