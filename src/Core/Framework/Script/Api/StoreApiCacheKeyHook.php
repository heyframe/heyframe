...
/**
 * Triggered when the api endpoint /front-api/script/{hook} is called. Used to provide a cache-key based on the request.
 * Needs to be implemented when your front-api route should be cached.
 *
