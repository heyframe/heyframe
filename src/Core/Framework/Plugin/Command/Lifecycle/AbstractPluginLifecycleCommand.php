...
namespace HeyFrame\Core\Framework\Plugin\Command\Lifecycle;
...
abstract class AbstractPluginLifecycleCommand extends Command
{
    ...
    protected function prepareExecution(
        ...
        $io->title('HeyFrame Plugin Lifecycle Service');
    ...
    protected function handleClearCacheOption(InputInterface $input, HeyFrameStyle $io, string $action): void
    {
