...
use HeyFrame\Core\Framework\Plugin\Requirement\Exception\ComposerNameMissingException;
use HeyFrame\Core\Framework\Plugin\Requirement\Exception\ConflictingPackageException;
use HeyFrame\Core\Framework\Plugin\Requirement\Exception\MissingRequirementException;
...
class RequirementsValidator
{
    ...
    private function checkComposerDependencies(
        ...
        foreach ($packages as $package) {
            // Ignore HeyFrame plugins. They are checked separately in `validateInstalledPlugins`
