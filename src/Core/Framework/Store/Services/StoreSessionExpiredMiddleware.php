...
{
    private const STORE_TOKEN_EXPIRED = 'HeyFramePlatformException-1';
    ...
    public function __invoke(ResponseInterface $response, RequestInterface $request): ResponseInterface
    {
        ...
        if ($token = $request->getHeaderLine(StoreRequestOptionsProvider::HEYFRAME_PLATFORM_TOKEN_HEADER)) {
