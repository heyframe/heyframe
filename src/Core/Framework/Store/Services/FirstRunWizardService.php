...
use HeyFrame\Core\Framework\Store\Event\FirstRunWizardStartedEvent;
use HeyFrame\Core\Framework\Store\Exception\LicenseDomainVerificationException;
use HeyFrame\Core\Framework\Store\Exception\StoreLicenseDomainMissingException;
use HeyFrame\Core\Framework\Store\Struct\AccessTokenStruct;
use HeyFrame\Core\Framework\Store\Struct\DomainVerificationRequestStruct;
use HeyFrame\Core\Framework\Store\Struct\ExtensionStruct;
use HeyFrame\Core\Framework\Store\Struct\FrwState;
use HeyFrame\Core\Framework\Store\Struct\LicenseDomainCollection;
use HeyFrame\Core\Framework\Store\Struct\LicenseDomainStruct;
use HeyFrame\Core\Framework\Store\Struct\PluginCategoryStruct;
use HeyFrame\Core\Framework\Store\Struct\PluginRecommendationCollection;
use HeyFrame\Core\Framework\Store\Struct\PluginRegionCollection;
use HeyFrame\Core\Framework\Store\Struct\PluginRegionStruct;
use HeyFrame\Core\Framework\Store\Struct\ShopUserTokenStruct;
...
class FirstRunWizardService
{
    ...
    public function frwLogin(string $heyframeId, string $password, Context $context): void
    {
        $accessTokenResponse = $this->frwClient->frwLogin($heyframeId, $password, $context);
