...
use HeyFrame\Core\Framework\Store\Struct\LicenseStruct;
...
use HeyFrame\Core\Framework\Store\Struct\StoreActionStruct;
use HeyFrame\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
...
class StoreClient
{
    public const EXTENSION_LICENSE_IS_ALREADY_CANCELLED = 'HeyFramePlatformException-61';
    ...
    public function loginWithHeyFrameId(string $heyframeId, string $password, Context $context): void
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'json' => [
                    'heyframeId' => $heyframeId,
                    'password' => $password,
                    'heyframeUserId' => $userId,
                ],
            ]
        );
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureHeyFrameVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    public function isShopUpgradeable(): bool
    {
        $response = $this->client->request(
            ...
            [
                'query' => [
                    'language' => 'en_GB',
                    'heyframeVersion' => $this->getHeyFrameVersion(),
                ],
            ]
        );
    ...
    protected function getHeyFrameVersion(): string
    {
        return $this->instanceService->getHeyFrameVersion();
    }
