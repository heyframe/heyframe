...
abstract class Plugin extends Bundle
{
     ...
     * If needed, return true and HeyFrame will execute `composer require` during the plugin installation.
     * When the plugins gets uninstalled, HeyFrame executes `composer remove`
     */
