...
namespace HeyFrame\Core\Framework\Gateway\Context\Command\Registry;

use HeyFrame\Core\Framework\Gateway\Context\Command\AbstractContextGatewayCommand;
use HeyFrame\Core\Framework\Gateway\Context\Command\Handler\AbstractContextGatewayCommandHandler;
...
class ContextGatewayCommandRegistry
{
    ...
    public function __construct(
        #[AutowireIterator('heyframe.context.gateway.command')]
        iterable $handlers,
    ) {
