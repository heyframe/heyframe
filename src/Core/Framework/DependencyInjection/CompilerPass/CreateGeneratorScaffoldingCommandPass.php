...
use HeyFrame\Core\Framework\Plugin\Command\MakerCommand;
...
class CreateGeneratorScaffoldingCommandPass implements CompilerPassInterface
{
    ...
    {
        $generators = $container->findTaggedServiceIds('heyframe.scaffold.generator');
        ...
        foreach ($generators as $id => $tags) {
            ...
            if (!is_subclass_of($class, ScaffoldingGenerator::class)) {
                throw DependencyInjectionException::taggedServiceHasWrongType($id, 'heyframe.scaffold.generator', ScaffoldingGenerator::class);
            }
