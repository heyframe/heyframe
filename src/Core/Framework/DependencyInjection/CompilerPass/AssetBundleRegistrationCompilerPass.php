...
use HeyFrame\Core\Framework\Adapter\Asset\AssetPackageService;
...
class AssetBundleRegistrationCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        array_unshift($arguments, new Reference('heyframe.asset.public.version_strategy'));
        array_unshift($arguments, new Reference('heyframe.asset.asset_without_versioning'));
