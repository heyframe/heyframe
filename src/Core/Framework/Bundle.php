...
abstract class Bundle extends SymfonyBundle
{
    ...
    /**
     * Returns a list of all action event class references of this bundle. The events will be registered inside the `\HeyFrame\Core\Framework\Event\BusinessEventRegistry`.
     *
