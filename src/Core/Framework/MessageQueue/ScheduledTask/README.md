...
The Scheduled Task system provides a robust framework for executing recurring background tasks in HeyFrame. It supports reliable scheduling, execution tracking, error handling, and automatic recovery mechanisms.
