...
This feature provides statistics about processed messages in the HeyFrame message queue system. It tracks message processing metrics and provides insights into message queue performance.
...
```json
{
    ...
    "messageTypeStats": [
        {
            "extensions": [],
            "type": "HeyFrame\\Core\\Framework\\Adapter\\Cache\\InvalidateCacheTask",
            "count": 1
        },
        {
            "extensions": [],
            "type": "HeyFrame\\Elasticsearch\\Framework\\Indexing\\CreateAliasTask",
            "count": 1
        },
        {
            "extensions": [],
            "type": "HeyFrame\\Core\\Content\\ProductExport\\ScheduledTask\\ProductExportGenerateTask",
            "count": 4
        }
    ]
}
