    ...
    public function __construct(
        ...
        if ($options === null || Feature::isActive('v6.8.0.0')) {
            ...
            if (!($options['criteria'] ?? null) instanceof Criteria) {
                throw FrameworkException::invalidOptions(\sprintf('Option "criteria" must be an instance of HeyFrame\Core\Framework\DataAbstractionLayer\Search\Criteria for constraint %s', self::class));
            }
