...
abstract class EntityExtension
{
     ...
     *
     * To load fields by your own, add the \HeyFrame\Core\Framework\DataAbstractionLayer\Field\Flag\Runtime flag to the field.
     * Added fields should have the \HeyFrame\Core\Framework\DataAbstractionLayer\Field\Flag\Extension which tells the DAL that this data
