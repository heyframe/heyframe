...
namespace HeyFrame\Core\Framework\Test\TestCaseHelper;
...
class TestBrowser extends KernelBrowser
{
     ...
     *
     * HeyFrame often wants to use that accept header with a value of `application/vnd.api+json,application/json`
     * see e.g. \HeyFrame\Core\Framework\Test\TestCaseBase\AdminApiTestBehaviour::createClient
     *
