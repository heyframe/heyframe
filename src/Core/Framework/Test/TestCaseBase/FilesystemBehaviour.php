...
use HeyFrame\Core\Framework\Test\Filesystem\Adapter\MemoryAdapterFactory;
...
trait FilesystemBehaviour
{
    ...
    {
        return $this->getFilesystem('heyframe.filesystem.public');
    }

    public function getPrivateFilesystem(): Filesystem
    {
        return $this->getFilesystem('heyframe.filesystem.private');
    }
