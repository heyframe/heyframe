...
trait StoreClientBehaviour
{
    public function getStoreRequestHandler(): MockHandler
    {
        ...
        $handler = static::getContainer()->get('heyframe.store.mock_handler');
    ...
    {
        /** @var MockHandler $handler */
        $handler = static::getContainer()->get('heyframe.frw.mock_handler');
    ...
    protected function getHeyFrameVersion(): string
    {
        ...
        return $instanceService->getHeyFrameVersion();
    }
