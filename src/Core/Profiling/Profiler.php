...
namespace HeyFrame\Core\Profiling;

use HeyFrame\Core\Framework\Log\Package;
use HeyFrame\Core\Profiling\Integration\ProfilerInterface;
...
{
    /**
     * Profilers will be activated over the heyframe.yaml file
     *
     ...
     * @return TReturn
     */
    public static function trace(string $name, \Closure $closure, string $category = 'heyframe', array $tags = [])
    {
