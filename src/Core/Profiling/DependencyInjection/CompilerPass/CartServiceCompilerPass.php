...
namespace HeyFrame\Core\Profiling\DependencyInjection\CompilerPass;
...
class CartServiceCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $definition->setArgument(1, $this->processTaggedServices($container, 'heyframe.cart.collector'));
        $definition->setArgument(2, $this->processTaggedServices($container, 'heyframe.cart.processor'));
    }
