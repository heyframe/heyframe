...
class ServiceReferenceGenerator implements ScriptReferenceGenerator
{
    ...
    final public const GITHUB_BASE_LINK = 'https://github.com/heyframe/heyframe/blob/trunk';
    ...
    {
        if (!str_starts_with($className, 'HeyFrame\\') || !\class_exists($className)) {
            return null;
        }
    ...
    private function findScriptServices(): array
    {
        ...
        foreach (ScriptReferenceDataCollector::getHeyFrameClasses() as $class) {
