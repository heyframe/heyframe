...
class NameConstantEntityDefinition implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (str_starts_with($namespace, 'HeyFrame\Core\Framework\DataAbstractionLayer\Attribute')) {
            return [];
        }
        if (str_starts_with($namespace, 'HeyFrame\Core\System\CustomEntity\Schema\Dynamic')) {
            return [];
        }
