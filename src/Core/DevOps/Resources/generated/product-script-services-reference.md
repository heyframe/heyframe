...
## [`HeyFrame\Core\Content\Product\Hook\Pricing\CheapestPriceFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Content/Product/Hook/Pricing/CheapestPriceFacade.php) {#cheapestpricefacade}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        ```
_________
## [`HeyFrame\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Content/Product/Hook/Pricing/PriceCollectionFacade.php) {#pricecollectionfacade}
...
_________
## [`HeyFrame\Core\Content\Product\Hook\Pricing\ProductProxy`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Content/Product/Hook/Pricing/ProductProxy.php) {#productproxy}
...
* **Returns** [`HeyFrame\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](./product-script-services-reference#pricecollectionfacade) | `null`
