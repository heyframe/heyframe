...
## [services.repository (`HeyFrame\Core\Framework\DataAbstractionLayer\Facade\RepositoryFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryFacade.php) {#repositoryfacade}
...
* **Returns** [`HeyFrame\Core\Framework\DataAbstractionLayer\Search\EntitySearchResult`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/EntitySearchResult.php)
...
* **Returns** [`HeyFrame\Core\Framework\DataAbstractionLayer\Search\IdSearchResult`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/IdSearchResult.php)
...
* **Returns** [`HeyFrame\Core\Framework\DataAbstractionLayer\Search\AggregationResult\AggregationResultCollection`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/AggregationResult/AggregationResultCollection.php)
...
* **Examples:**
    * Aggregate data for multiple entities, e.g. the sum of the gross price of all products.
        ...
        ```
_________
## [services.store (`HeyFrame\Core\Framework\DataAbstractionLayer\Facade\ChannelRepositoryFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/ChannelRepositoryFacade.php) {#saleschannelrepositoryfacade}
