...
## [services.cart (`HeyFrame\Core\Checkout\Cart\Facade\CartFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/CartFacade.php) {#cartfacade}
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\ItemsFacade`](./cart-manipulation-script-services-reference#itemsfacade)
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\ProductsFacade`](./cart-manipulation-script-services-reference#productsfacade)
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\CartPriceFacade`](./cart-manipulation-script-services-reference#cartpricefacade)
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\ErrorsFacade`](./cart-manipulation-script-services-reference#errorsfacade)
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\StatesFacade`](./cart-manipulation-script-services-reference#statesfacade)
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\DiscountFacade`](./cart-manipulation-script-services-reference#discountfacade)
...
* **Examples:**
    * Add an absolute discount to the cart.
        ...
        ```twig
        {# @var services \HeyFrame\Core\Framework\Script\ServiceStubs #}
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade) | `null`
...
* **Examples:**
    ...
    * Add a relative surcharge to the cart.
        ...
        ```
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\CartPriceFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/CartPriceFacade.php) {#cartpricefacade}
...
* **Returns** [`HeyFrame\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        ```
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\ContainerFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/ContainerFacade.php) {#containerfacade}
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)

    The item that was added to the container.
* **Arguments:**
    * *[`HeyFrame\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)* **item**: The item that should be added.
* **Examples:**
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Facade\PriceFacade`](./cart-manipulation-script-services-reference#pricefacade) | `null`
...
* **Returns** [`HeyFrame\Core\Framework\Script\Facade\ArrayFacade`](./miscellaneous-script-services-reference#arrayfacade)
...
* **Examples:**
    ...
    * Add a relative surcharge to the cart.
        ...
        ```
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\DiscountFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/DiscountFacade.php) {#discountfacade}
...
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\ErrorsFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/ErrorsFacade.php) {#errorsfacade}
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Error\Error`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\ItemFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/ItemFacade.php) {#itemfacade}
...
* **Returns** `string`
    ...
    The type of the line-item.
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\ItemsFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/ItemsFacade.php) {#itemsfacade}
...
* **Arguments:**
    * *[`HeyFrame\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)* **item**: The line-item that should be added.
* **Examples:**
    * Add an absolute discount to the cart.
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        ```
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\PriceFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFacade.php) {#pricefacade}
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Tax\Struct\CalculatedTaxCollection`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/CalculatedTaxCollection.php)
...
* **Returns** [`HeyFrame\Core\Checkout\Cart\Tax\Struct\TaxRuleCollection`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/TaxRuleCollection.php)
...
* **Arguments:**
    * *[`HeyFrame\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)* **price**: The provided price can be a fetched price from the database or generated over the `PriceFactory` statically
* **Examples:**
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        ```
_________
## [services.price (`HeyFrame\Core\Checkout\Cart\Facade\PriceFactory`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFactory.php) {#pricefactory}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        ```
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\ProductsFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/ProductsFacade.php) {#productsfacade}
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        ```
_________
## [`HeyFrame\Core\Checkout\Cart\Facade\StatesFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Checkout/Cart/Facade/StatesFacade.php) {#statesfacade}
