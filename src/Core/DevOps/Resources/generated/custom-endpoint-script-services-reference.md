...
## [services.cache (`HeyFrame\Core\Framework\Adapter\Cache\Script\Facade\CacheInvalidatorFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/Adapter/Cache/Script/Facade/CacheInvalidatorFacade.php) {#cacheinvalidatorfacade}
...
* **Examples:**
    ...
    * Build tags if products with a specific property is created and invalidate those tags.
        ...
        ```
_________
## [services.writer (`HeyFrame\Core\Framework\DataAbstractionLayer\Facade\RepositoryWriterFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryWriterFacade.php) {#repositorywriterfacade}
...
* **Returns** [`HeyFrame\Core\Framework\DataAbstractionLayer\Event\EntityWrittenContainerEvent`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/DataAbstractionLayer/Event/EntityWrittenContainerEvent.php)
...
* **Returns** [`HeyFrame\Core\Framework\Api\Sync\SyncResult`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/Api/Sync/SyncResult.php)
...
* **Examples:**
    * Update an entity and delete another one with one `sync()` call.
        ...
        ```
_________
## [services.response (`HeyFrame\Core\Framework\Script\Api\ScriptResponseFactoryFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/Script/Api/ScriptResponseFactoryFacade.php) {#scriptresponsefactoryfacade}
