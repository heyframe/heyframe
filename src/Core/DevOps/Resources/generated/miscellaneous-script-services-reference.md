...
## [services.request (`HeyFrame\Core\Framework\Routing\Facade\RequestFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/Routing/Facade/RequestFacade.php) {#requestfacade}
...
* **Returns** `array`
    ...
    request cookies
_________
## [services.acl (`HeyFrame\Core\Framework\Script\Api\AclFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/Script/Api/AclFacade.php) {#aclfacade}
...
* **Examples:**
    * Check for the `product:read` permission and query a product if the permission is granted.
        ...
        ```
_________
## [`HeyFrame\Core\Framework\Script\Facade\ArrayFacade`](https://github.com/heyframe/heyframe/blob/trunk/src/Core/Framework/Script/Facade/ArrayFacade.php) {#arrayfacade}
...
_________
## [services.config (`HeyFrame\Core\System\SystemConfig\Facade\SystemConfigFacade`)](https://github.com/heyframe/heyframe/blob/trunk/src/Core/System/SystemConfig/Facade/SystemConfigFacade.php) {#systemconfigfacade}
...
* **Arguments:**
    ...
    * *`string` | `null`* **channelId**: The ChannelId if you need the config value for a specific Channel, if you don&#039;t provide a ChannelId, the one of the current Context is used as default.
