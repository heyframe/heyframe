...
abstract class AbstractThemePathBuilder
{
     ...
     */
    abstract public function assemblePath(string $channelId, string $themeId): string;
     ...
     */
    abstract public function generateNewPath(string $channelId, string $themeId, string $seed): string;
     ...
     */
    abstract public function saveSeed(string $channelId, string $themeId, string $seed): void;
}
