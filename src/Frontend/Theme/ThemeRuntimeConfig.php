 ...
 *
 * Most of the properties are calculated during HeyFrame\Frontend\Theme\ThemeLifecycleService::refreshTheme.
 * The $scriptFiles are calculated just after HeyFrame\Frontend\Theme\ThemeCompiler::compileTheme.
 *
