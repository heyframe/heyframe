...
namespace HeyFrame\Frontend\Theme\Controller;
...
use HeyFrame\Frontend\Theme\Exception\ThemeConfigException;
...
class ThemeController extends AbstractController
{
     ...
     * frontend for customers visiting that sales channel. Only one theme can be
     * active per sales channel at a time.
     *
     * @param string $themeId The unique identifier of the theme to assign
     * @param string $channelId The unique identifier of the sales channel
     * @param Context $context The application context containing user and system information
     *
     * @return JsonResponse Returns an empty JSON response on successful assignment
     */
    #[Route(path: '/api/_action/theme/{themeId}/assign/{channelId}', name: 'api.action.theme.assign', methods: ['POST'])]
    public function assignTheme(string $themeId, string $channelId, Context $context): JsonResponse
    {
        $this->themeService->assignTheme($themeId, $channelId, $context);
     ...
     * The response format differs based on the HeyFrame version for backward compatibility.
     *
     * @param string $themeId The unique identifier of the theme
     * @param Context $context The application context containing user and system information
     *
