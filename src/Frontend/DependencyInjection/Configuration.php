...
namespace HeyFrame\Frontend\DependencyInjection;

use HeyFrame\Core\Framework\Log\Package;
use HeyFrame\Frontend\Theme\ConfigLoader\DatabaseAvailableThemeProvider;
use HeyFrame\Frontend\Theme\ConfigLoader\DatabaseConfigLoader;
use HeyFrame\Frontend\Theme\SeedingThemePathBuilder;
                ...
                ->arrayNode('theme')
                    ->children()
                        ...
                        ->integerNode('file_delete_delay')
                            ->setDeprecated('heyframe/frontend', '6.8.0', 'The "%node%" option is deprecated and will be removed in 6.8.0 as it has no effect anymore.')
