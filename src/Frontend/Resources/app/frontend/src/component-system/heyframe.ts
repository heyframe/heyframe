...
import type HeyFrameComponent from './component';
...
/**
 * Global HeyFrame class.
 *
 * This class is the central point for all component-system related functionality.
 * It is a singleton and can be accessed via `window.HeyFrame`.
 *
 * @sw-package framework
 */
class Heyframe extends EventEmitter {

    // Singleton instance.
    public static instance: Heyframe;
    ...
    private componentRegistry: Map<string, typeof HeyFrameComponent>;
    ...
    constructor() {
        ...
        // Singleton
        if (!Heyframe.instance) {
            Heyframe.instance = this;
        }

        return Heyframe.instance;
    }
     ...
     */
    public registerComponent(componentName: string, component: typeof HeyFrameComponent): void {
     ...
     */
    public getComponent(componentName: string): typeof HeyFrameComponent | undefined {
     ...
     */
    public getComponentInstances(componentName: string): HeyFrameComponent[] {
     ...
     */
    public getComponentInstanceByElement(componentName: string, element: Node): HeyFrameComponent | undefined {
    ...
    public callMethod(componentName: string, methodName: string, ...args: any[]): void {
        ...
        componentInstances.forEach(instance => {
            if (instance[methodName as keyof HeyFrameComponent] &&
                typeof instance[methodName as keyof HeyFrameComponent] === 'function') {
                (instance[methodName as keyof HeyFrameComponent] as Function).call(instance, ...args);
            }
        });
    }
