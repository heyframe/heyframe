...
class ThemeApiService extends ApiService {
    ...
    assignTheme(themeId, channelId, additionalParams = {}, additionalHeaders = {}) {
        const apiRoute = `/_action/${this.getApiBasePath()}/${themeId}/assign/${channelId}`;
    ...
    getConfiguration(themeId) {
        ...
        const additionalHeaders = {
            'sw-language-id': HeyFrame.Store.get('session').languageId
        };
