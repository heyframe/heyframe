...
Component.register('sw-theme-manager-list', {
    ...
    methods: {
        ...
        getList() {
            ...
            return this.themeRepository.search(criteria, HeyFrame.Context.api).then((searchResult) => {
        ...
        onChangeLanguage(languageId) {
            HeyFrame.Context.api.languageId = languageId;
            this.resetList();
        },
        ...
        saveTheme(theme) {
            this.isLoading = true;
            return this.themeRepository.save(theme, HeyFrame.Context.api).then(() => {
                this.isLoading = false;
            }).catch(() => {
                this.isLoading = false;
            });
        ...
        deleteDisabledToolTip(theme) {
            return {
                ...
                disabled: theme.channels.length === 0
            };
        }
    }
});
