...
Mixin.register('theme', {
    ...
    methods: {
        ...
        deleteTheme(theme) {
            ...
            this.isLoading = true;
            this.themeRepository.delete(theme.id, HeyFrame.Context.api).then(() => {
                if (this.getList) {
                    this.getList();
                    return;
                }
        ...
        duplicateTheme(parentTheme, name) {
            const themeDuplicate = this.themeRepository.create(HeyFrame.Context.api);
            ...
            this.themeRepository.save(themeDuplicate, HeyFrame.Context.api).then(() => {
        ...
        RenameTheme(theme, name) {
            ...
            this.themeRepository.save(theme, HeyFrame.Context.api);
        }
    }
});
