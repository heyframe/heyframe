import template from './sw-channel-detail-theme.html.twig';
import './sw-channel-detail-theme.scss';
...
Component.register('sw-channel-detail-theme', {
    template,
    ...
    watch: {
        'channel.extensions.themes': {
            deep: true,
            handler() {
                this.getTheme(this.channel?.extensions?.themes[0]?.id);
            }
        }
    },
    ...
    methods: {
        createdComponent() {
            if (!this.channel?.extensions?.themes[0]) {
                return;
            }

            this.theme = this.channel.extensions.themes[0];
        ...
        async getTheme(themeId) {
            ...
            this.theme = await this.themeRepository.get(themeId, HeyFrame.Context.api, criteria);
        },
        ...
        async onChangeTheme(themeId) {
            ...
            this.channel.extensions.themes[0] = this.theme;
        },
    },
});
